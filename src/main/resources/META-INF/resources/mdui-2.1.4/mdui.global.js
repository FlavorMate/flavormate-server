/*!
 * mdui 2.1.4 (https://www.mdui.org)
 * Copyright 2016-2025 zdhxiong <zdhxiong@gmail.com>
 * Licensed under MIT
 */
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], t)
    : t(
        ((e = "undefined" != typeof globalThis ? globalThis : e || self).mdui =
          {})
      );
})(this, function (e) {
  "use strict";
      ...
      const e = function (t) {
        ...
        if (l(t)) {
          ...
          return (
            S(i)
              ? t.call(i, e)
              : i.addEventListener("DOMContentLoaded", () => t.call(i, e), {
                  once: !0,
                }),
            new I([i])
          );
        ...
        ((e, i, o) => {
          ...
          (i = k(i)),
            e.style.setProperty(
              i,
              d(o)
                ? `${o}${i.startsWith("--") || K.includes(i) ? "" : "px"}`
                : o
            );
    ...
    (M.fn.on = function (e, t, i, o, n) {
      ...
      if (
        (null == i && null == o
          ? ((o = t), (i = t = void 0))
          : null == o &&
            (c(t) ? ((o = i), (i = void 0)) : ((o = i), (i = t), (t = void 0))),
        !1 === o)
      )
        o = C;
              ...
              const s = ce(t),
                a = (e, t) => {
                  !1 ===
                    i.apply(
                      t,
                      null === e.detail ? [e] : [e].concat(e.detail)
  ...
  (M.fn.removeData = function (e) {
    ...
    (M.fn.replaceAll = function (e) {
      return M(e).map(
        (e, t) => (M(t).replaceWith(e ? this.clone() : this), this.get())
      );
    });
  const ve = (e) => {
      ...
      return (
        Array.isArray(e) ? $(e, ({ name: e, value: t }) => i(e, t)) : R(e, i),
        t.join("&")
      );
    },
    ge = new WeakMap(),
        ...
        return new Promise((t, n) => {
          ...
          if (
            ...
            (m.onload = () => {
              S && clearTimeout(S);
              const i =
                ((o = m.status) >= 200 && o < 300) || [0, 304].includes(o);
              var o;
              let n;
              if (i)
                if (
                  ...
                  "json" === C ||
                    (!C &&
                      (m.getResponseHeader("content-type") || "").includes(
                        "json"
                      )))
                ) {
                  try {
      ...
      : (e) =>
          e instanceof CSSStyleSheet
            ? ((e) => {
                ...
                return ((e) =>
                  new Me("string" == typeof e ? e : e + "", void 0, De))(t);
              })(e)
            : e,
    {
      is: _e,
  ...
  let Ye = class extends HTMLElement {
        ...
        const e = i.getPropertyOptions(o),
          n =
            "function" == typeof e.converter
              ...
              : je;
        (this._$Em = o),
          (this[o] = n.fromAttribute(t, e.type) ?? this._$Ej?.get(o) ?? null),
          (this._$Em = null);
      }
    }
    requestUpdate(e, t, i) {
    ...
    C(e, t, { useDefault: i, reflect: o, wrapped: n }, r) {
      (i &&
        ...
        !0 === o && this._$Em !== e && (this._$Eq ??= new Set()).add(e));
    }
    async _$EP() {
  ...
  (Ye.elementStyles = []),
    ...
    (Ve.reactiveElementVersions ??= []).push("2.1.0");
  const Xe = globalThis,
    Je = Xe.trustedTypes,
          ...
          if (o.hasAttributes())
            for (const e of o.getAttributeNames())
              if (e.endsWith(Qe)) {
                ...
                e.startsWith(et) &&
                  (a.push({ type: 6, index: n }), o.removeAttribute(e));
  ...
  class Rt {
      ...
      const { values: t, _$litType$: i } = e,
        o =
          "number" == typeof i
            ? this._$AC(e)
            : (void 0 === i.el &&
                (i.el = Ct.createElement(wt(i.h, i.h[0]), this.options)),
              i);
    ...
    k(e) {
      ...
      for (const n of e)
        o === t.length
          ? t.push((i = new Rt(this.O(nt()), this.O(nt()), this, this.options)))
          : (i = t[o]),
          i._$AI(n),
          o++;
  ...
  At?.(Ct, Rt), (Xe.litHtmlVersions ??= []).push("3.3.0");
  const Mt = globalThis;
  ...
  (Pt._$litElement$ = !0),
    (Pt.finalized = !0),
    Mt.litElementHydrateSupport?.({ LitElement: Pt });
  const Lt = Mt.litElementPolyfillSupport;
  Lt?.({ LitElement: Pt }), (Mt.litElementVersions ??= []).push("4.2.0");
  const _t = (e) => (t, i) => {
      void 0 !== i
        ? i.addInitializer(() => {
    ...
    Ot = (e = Bt, t, i) => {
      ...
      if (
        ...
        "setter" === o && ((e = Object.create(e)).wrapped = !0),
        r.set(i.name, e),
        "accessor" === o)
      ) {
        const { name: o } = i;
        return {
          ...
          init(t) {
            return void 0 !== t && this.C(o, void 0, e, t), t;
          },
        };
      }
      if ("setter" === o) {
    ...
    Xt = jt(
      class extends Wt {
        constructor(e) {
          if (
            (super(e),
            e.type !== Ht || "style" !== e.name || e.strings?.length > 2)
          )
            throw Error(
        ...
        update(e, [t]) {
          ...
          for (const e in t) {
            ...
            if (null != o) {
              this.ft.add(e);
              const t = "string" == typeof o && o.endsWith(Yt);
              e.includes("-") || t
                ? i.setProperty(e, t ? o.slice(0, -11) : o, t ? Gt : "")
                : (i[e] = o);
            }
          }
          return vt;
  ...
  const Qt = ft`${gt}`,
    ei = Pe`:host{box-sizing:border-box}:host *,:host ::after,:host ::before{box-sizing:inherit}:host :focus,:host :focus-visible,:host(:focus),:host(:focus-visible){outline:0}[hidden]{display:none!important}`;
  let ti = class extends Wt {
    constructor(e) {
      if ((super(e), (this.it = gt), e.type !== Ut))
        throw Error(
  ...
  class ii extends ti {}
  (ii.directiveName = "unsafeSVG"), (ii.resultType = 2);
  const oi = jt(ii),
    ni = (e) => void 0 === e.strings,
    ri = {},
    si = (e, t) => {
      const i = e._$AN;
      if (void 0 === i) return !1;
      for (const e of i) e._$AO?.(t, !1), si(e, t);
      return !0;
    },
    ai = (e) => {
      let t, i;
  ...
  function di(e, t = !1, i = 0) {
    ...
    if (void 0 !== n && 0 !== n.size)
      if (t)
        if (Array.isArray(o))
          for (let e = i; e < o.length; e++) si(o[e], !1), ai(o[e]);
        else null != o && (si(o, !1), ai(o));
      else si(this, e);
  }
  const hi = (e) => {
    e.type == Ut && ((e._$AP ??= di), (e._$AQ ??= ci));
  };
  class ui extends Wt {
    constructor() {
    ...
    _$AT(e, t, i) {
      super._$AT(e, t, i), li(this), (this.isConnected = e._$AU);
    }
    _$AO(e, t = !0) {
      e !== this.isConnected &&
        ((this.isConnected = e),
      ...
      class extends ui {
        constructor() {
          super(...arguments),
            (this._$Cwt = vi),
            (this._$Cbt = []),
            (this._$CK = new pi(this)),
            (this._$CX = new mi());
        }
        render(...e) {
          return e.find((e) => !fi(e)) ?? vt;
        }
        update(e, t) {
          const i = this._$Cbt;
          let o = i.length;
      ...
      return this.hasSlotController.test("[default]")
        ...
        : (() => {
            if (this.name) {
              ...
              return ft`<span translate="no" style="${Xt({
                fontFamily: i.get(t),
              })}">${e}</span>`;
            }
            return this.src ? ft`${gi(Ie({ url: this.src }).then(oi))}` : ft``;
          })();
    }
  }),
    (e.Icon.styles = [ei, bi]),
    Se([zt({ reflect: !0 })], e.Icon.prototype, "name", void 0),
    Se([zt({ reflect: !0 })], e.Icon.prototype, "src", void 0),
    (e.Icon = Se([_t("mdui-icon")], e.Icon));
  ...
  (e.Avatar = class extends Jt {
    ...
    render() {
      return this.hasSlotController.test("[default]")
        ? ft`<slot></slot>`
        : this.src
        ? ft`<img part="image" alt="${Vt(this.label)}" src="${
            this.src
          }" style="${Xt({ objectFit: this.fit })}">`
        : this.icon
        ? ft`<mdui-icon part="icon" name="${this.icon}"></mdui-icon>`
        : Qt;
    }
  }),
    (e.Avatar.styles = [ei, yi]),
    Se([zt({ reflect: !0 })], e.Avatar.prototype, "src", void 0),
    Se([zt({ reflect: !0 })], e.Avatar.prototype, "fit", void 0),
    Se([zt({ reflect: !0 })], e.Avatar.prototype, "icon", void 0),
    Se([zt({ reflect: !0 })], e.Avatar.prototype, "label", void 0),
    (e.Avatar = Se([_t("mdui-avatar")], e.Avatar));
  ...
  (e.Badge = class extends Jt {
    constructor() {
      super(...arguments), (this.variant = "large");
    }
    render() {
      return "small" === this.variant ? Qt : ft`<slot></slot>`;
    }
  }),
    (e.Badge.styles = [ei, wi]),
    Se([zt({ reflect: !0 })], e.Badge.prototype, "variant", void 0),
    (e.Badge = Se([_t("mdui-badge")], e.Badge));
  const ki = (e) => null !== e && "false" !== e.toLowerCase();
  class Ci {
    constructor(e, t) {
      (this.defined = !1),
        (this.host = e).addController(this),
    ...
    isDefined() {
      return (
        !!this.defined ||
        ((this.defined =
          (!this.needDomReady || S()) && !this.getUndefinedLocalNames().length),
        this.defined)
      );
    }
    async whenDefined() {
  ...
  const $i = new WeakMap(),
    Ri = (e) => {
      class t extends e {
        constructor(...e) {
          super(...e),
            (this.scrollBehaviorDefinedController = new Ci(this, {
              needDomReady: !0,
            })),
          ...
          e &&
            (this.scrollBehavior
              ? (this.updateScrollTop(e),
                e.addEventListener("scroll", this.onListeningScroll))
        ...
        setContainerPadding(e, t) {
          ...
          if ("add" === e || "update" === e) {
            ...
            if ((M(i).css({ [n]: t }), "add" === e && null !== t)) {
              const e = $i.get(i) ?? { top: [], bottom: [] };
              e[o].push(this), $i.set(i, e);
            }
          }
          if ("remove" === e) {
            const e = $i.get(i);
      ...
      return (
        Se(
          [zt({ attribute: "scroll-target" })],
          t.prototype,
          "scrollTarget",
          void 0
        ),
        Se(
          [zt({ reflect: !0, attribute: "scroll-behavior" })],
          t.prototype,
          "scrollBehavior",
          void 0
        ),
        Se(
          [zt({ type: Number, reflect: !0, attribute: "scroll-threshold" })],
          t.prototype,
          "scrollThreshold",
          void 0
        ),
        Se([xi("scrollTarget")], t.prototype, "onScrollTargetChange", null),
        Se([xi("scrollBehavior")], t.prototype, "onScrollBehaviorChange", null),
        t
      );
    };
  let Ii = 0;
        ...
        unobserve: () => {
          i.each((e, t) => {
            ...
            -1 !== n && i.coArr.splice(n, 1),
              i.coArr.length ? Ei.set(t, i) : (Ti.unobserve(t), Ei.delete(t));
          });
        },
      };
    return (
      ...
      Object.assign(this.states[o], i),
        this.states.forEach((e, t) => {
          ...
          const i = e.element.layoutPlacement,
            ...
            l = n?.left ?? 0;
          switch (
            (Object.assign(e, { top: r, right: s, bottom: a, left: l }), i)
          ) {
            case "top":
            case "bottom":
            ...
            case "left":
              e[i] +=
                (this.isNoWidth(e) ? 0 : e.width) ?? e.element.offsetWidth;
          }
  ...
  const Mi = new WeakMap(),
    Pi = (e) => (Mi.has(e) || Mi.set(e, new Ai()), Mi.get(e));
  class Li extends Jt {
    constructor() {
    ...
    connectedCallback() {
      ...
      (this.isParentLayout = a(e, "mdui-layout")),
        this.isParentLayout &&
          ((this.layoutManager = Pi(e)), this.layoutManager.registerItem(this));
    }
    disconnectedCallback() {
      super.disconnectedCallback(),
  ...
  (e.BottomAppBar = class extends Ri(Li) {
    ...
    (e.BottomAppBar.styles = [ei, _i]),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
    ...
    (e.BottomAppBar = Se([_t("mdui-bottom-app-bar")], e.BottomAppBar));
  const Bi = () => new Oi();
  class Oi {}
    ...
    Ni = jt(
      class extends ui {
        ...
        update(e, [t]) {
          const i = t !== this.G;
          return (
            i && void 0 !== this.G && this.rt(void 0),
            (i || this.lt !== this.ct) &&
              ((this.G = t),
        ...
        rt(e) {
          if ((this.isConnected || (e = void 0), "function" == typeof this.G)) {
            ...
            let i = zi.get(t);
            void 0 === i && ((i = new WeakMap()), zi.set(t, i)),
        ...
        get lt() {
          return "function" == typeof this.G
            ? zi.get(this.ht ?? globalThis)?.get(this.G)
            : this.G?.value;
        }
        disconnected() {
  ...
  class Ui {
    constructor(e, t) {
      (this.host = e).addController(this),
        (this.definedController = new Ci(e, { needDomReady: !0 })),
        (this.options = {
          form: (e) => {
    ...
    attachForm(e) {
      e
        ? ((this.form = e),
          ...
          Vi.has(this.form) ||
            (Vi.set(this.form, this.form.reportValidity),
    ...
    detachForm() {
      this.form &&
        ...
        Vi.has(this.form) &&
          ...
          ((this.form.reportValidity = Vi.get(this.form)),
          Vi.delete(this.form)));
    }
    doAction(e, t) {
      if (!this.form) return;
    ...
    onFormReset() {
      this.form &&
        ...
        (this.host.invalid = !1),
        Hi.has(this.form)
          ? Hi.get(this.form).add(this.host)
  ...
  const Ki = (e) => {
    class t extends e {
      renderAnchor({
        ...
        return ft`<a ${n} id="${Vt(e)}" class="_a ${t || ""}" part="${Vt(
          i
        )}" href="${Vt(this.href)}" download="${Vt(
          this.download
        )}" target="${Vt(this.target)}" rel="${Vt(this.rel)}" tabindex="${Vt(
          r
        )}">${o}</a>`;
      }
    }
    return (
      Se([zt({ reflect: !0 })], t.prototype, "href", void 0),
      Se([zt({ reflect: !0 })], t.prototype, "download", void 0),
      Se([zt({ reflect: !0 })], t.prototype, "target", void 0),
      Se([zt({ reflect: !0 })], t.prototype, "rel", void 0),
      t
    );
  };
  let qi = !0;
  const ji = n();
  ji.addEventListener("pointerdown", () => {
    qi = !0;
  }),
    ji.addEventListener("keydown", () => {
      qi = !1;
    });
  const Wi = (e) => {
      class t extends e {
        constructor() {
          super(...arguments),
            ...
            (this.focused = !1),
            (this.focusVisible = !1),
            (this.focusableDefinedController = new Ci(this, {
              relatedElements: [""],
            })),
        ...
        firstUpdated(e) {
          super.firstUpdated(e),
            this.focusElement.addEventListener("focus", () => {
              (this.focused = !0), (this.focusVisible = !qi);
            }),
      ...
      return (
        ...
        Se(
          [zt({ type: Number, attribute: "tabindex" })],
          t.prototype,
          "tabIndex",
          null
        ),
    ...
    Gi = jt(
      class extends Wt {
        constructor(e) {
          if (
            (super(e),
            e.type !== Ht || "class" !== e.name || e.strings?.length > 2)
          )
            throw Error(
  ...
  (e.Ripple = class extends Jt {
    ...
    render() {
      return ft`<div ${Ni(this.surfaceRef)} class="surface ${Gi({
        hover: this.hover,
    ...
    Se([Nt()], e.Ripple.prototype, "hover", void 0),
    Se([Nt()], e.Ripple.prototype, "focused", void 0),
    Se([Nt()], e.Ripple.prototype, "dragged", void 0),
    (e.Ripple = Se([_t("mdui-ripple")], e.Ripple));
  const Ji = (e) => {
      class t extends e {
        constructor() {
          super(...arguments),
    ...
    Zi = Pe`.button{position:relative;display:inline-flex;align-items:center;justify-content:center;height:100%;padding:0;overflow:hidden;color:inherit;font-size:inherit;font-family:inherit;font-weight:inherit;letter-spacing:inherit;white-space:nowrap;text-align:center;text-decoration:none;vertical-align:middle;background:0 0;border:none;outline:0;cursor:inherit;-webkit-user-select:none;user-select:none;touch-action:manipulation;zoom:1;-webkit-user-drag:none}`;
  class Qi extends Ki(Ji(Wi(Jt))) {
    constructor() {
      super(...arguments),
        (this.disabled = !1),
        (this.loading = !1),
        ...
        (this.formController = new Ui(this));
    }
    get validity() {
    ...
    renderButton({
      ...
      return ft`<button id="${Vt(
        e
      )}" class="${Fi(["_button", t])}" part="${Vt(i)}" ?disabled="${this.rippleDisabled || this.focusDisabled}">${o}</button>`;
    }
    isButton() {
      return !this.href;
    }
  ...
  (Qi.styles = [ei, Zi]),
    ...
    Se([zt({ reflect: !0 })], Qi.prototype, "name", void 0),
    Se([zt({ reflect: !0 })], Qi.prototype, "value", void 0),
    Se([zt({ reflect: !0 })], Qi.prototype, "type", void 0),
    Se([zt({ reflect: !0 })], Qi.prototype, "form", void 0),
    Se(
      [zt({ reflect: !0, attribute: "formaction" })],
      Qi.prototype,
      "formAction",
      void 0
    ),
    Se(
      [zt({ reflect: !0, attribute: "formenctype" })],
      Qi.prototype,
      "formEnctype",
      void 0
    ),
    Se(
      [zt({ reflect: !0, attribute: "formmethod" })],
      Qi.prototype,
      "formMethod",
      void 0
    ),
    ...
    Se(
      [zt({ reflect: !0, attribute: "formtarget" })],
      Qi.prototype,
      "formTarget",
      void 0
    );
  ...
  (e.Button = class extends Qi {
    ...
    render() {
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${
        this.noRipple
      }"></mdui-ripple>${
        this.isButton()
          ? this.renderButton({
    ...
    renderIcon() {
      return this.loading
        ...
        : ft`<slot name="icon" part="icon" class="icon">${
            this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Qt
          }</slot>`;
    }
    renderLabel() {
    ...
    renderEndIcon() {
      return ft`<slot name="end-icon" part="end-icon" class="end-icon">${
        this.endIcon ? ft`<mdui-icon name="${this.endIcon}"></mdui-icon>` : Qt
      }</slot>`;
    }
    renderInner() {
    ...
    (e.Button.styles = [Qi.styles, eo]),
    Se([zt({ reflect: !0 })], e.Button.prototype, "variant", void 0),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se([zt({ reflect: !0 })], e.Button.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "end-icon" })],
      e.Button.prototype,
      "endIcon",
      void 0
    ),
    (e.Button = Se([_t("mdui-button")], e.Button));
  ...
  (e.ButtonIcon = class extends Qi {
    constructor() {
      super(...arguments),
        ...
        (this.selected = !1),
        (this.rippleRef = Bi()),
        (this.hasSlotController = new Zt(this, "[default]", "selected-icon"));
    }
    get rippleElement() {
      return this.rippleRef.value;
    }
    ...
    (e.ButtonIcon.styles = [Qi.styles, to]),
    Se([zt({ reflect: !0 })], e.ButtonIcon.prototype, "variant", void 0),
    Se([zt({ reflect: !0 })], e.ButtonIcon.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "selected-icon" })],
  ...
  (e.Card = class extends Ki(Ji(Wi(Jt))) {
    ...
    (e.Card.styles = [ei, io]),
    Se([zt({ reflect: !0 })], e.Card.prototype, "variant", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Card.prototype,
      "clickable",
    ...
    (e.Card = Se([_t("mdui-card")], e.Card));
  const oo = jt(
    class extends Wt {
      constructor(e) {
        if ((super(e), e.type !== Kt && e.type !== Ht && e.type !== qt))
          throw Error(
      ...
      update(e, [t]) {
        ...
        } else if (e.type === Ht && i.getAttribute(o) === t + "") return vt;
        return (
          ((e, t = ri) => {
            e._$AH = t;
          })(e),
  ...
  const ro = Pe`:host{display:inline-block;width:1em;height:1em;line-height:1;font-size:1.5rem}`,
    so = (e) =>
      ft`<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="currentColor">${oi(
        e
      )}</svg>`;
  let ao = class extends Pt {
    render() {
      return so(
  ...
  (ao.styles = ro), (ao = Se([_t("mdui-icon-check-box-outline-blank")], ao));
  ...
  (lo.styles = ro), (lo = Se([_t("mdui-icon-check-box")], lo));
  let co = class extends Pt {
    render() {
      return so(
  ...
  (e.Checkbox = class extends Ji(Wi(Jt)) {
    ...
    async onCheckedChange() {
      ...
      e && Hi.get(e)?.has(this)
        ? ((this.invalid = !1), Hi.get(e).delete(this))
        : (this.invalid = !this.inputRef.value.checkValidity());
    }
    checkValidity() {
    ...
    reportValidity() {
      if (
        ((this.invalid = !this.inputRef.value.reportValidity()), this.invalid)
      ) {
        this.emit("invalid", { bubbles: !1, cancelable: !0, composed: !1 }) ||
    ...
    render() {
      return ft`<label class="${Gi({ invalid: this.invalid })}"><input ${Ni(
        this.inputRef
      )} type="checkbox" name="${Vt(this.name)}" value="${Vt(
        this.value
      )}" .indeterminate="${oo(this.indeterminate)}" .disabled="${
        this.disabled
      }" .checked="${oo(this.checked)}" .required="${this.required}" @change="${
        this.onChange
      }"> <i part="control"><mdui-ripple ${Ni(this.rippleRef)} .noRipple="${
        this.noRipple
    ...
    Se([no("checked")], e.Checkbox.prototype, "defaultChecked", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Checkbox.prototype,
      "indeterminate",
    ...
    Se([zt({ reflect: !0 })], e.Checkbox.prototype, "form", void 0),
    Se([zt({ reflect: !0 })], e.Checkbox.prototype, "name", void 0),
    Se([zt({ reflect: !0 })], e.Checkbox.prototype, "value", void 0),
    Se(
      [zt({ reflect: !0, attribute: "unchecked-icon" })],
      e.Checkbox.prototype,
      "uncheckedIcon",
      void 0
    ),
    Se(
      [zt({ reflect: !0, attribute: "checked-icon" })],
      e.Checkbox.prototype,
      "checkedIcon",
      void 0
    ),
    Se(
      [zt({ reflect: !0, attribute: "indeterminate-icon" })],
      e.Checkbox.prototype,
      "indeterminateIcon",
      void 0
    ),
    Se([Nt()], e.Checkbox.prototype, "invalid", void 0),
    Se(
      [xi("disabled", !0), xi("indeterminate", !0), xi("required", !0)],
      e.Checkbox.prototype,
      "onDisabledChange",
      null
    ),
    Se([xi("checked", !0)], e.Checkbox.prototype, "onCheckedChange", null),
    (e.Checkbox = Se([_t("mdui-checkbox")], e.Checkbox));
  let uo = class extends Pt {
    render() {
      return so(
  ...
  (uo.styles = ro), (uo = Se([_t("mdui-icon-check")], uo));
  let po = class extends Pt {
    render() {
      return so(
  ...
  (e.Chip = class extends Qi {
    ...
    render() {
      const e = this.icon || this.hasSlotController.test("icon"),
        ...
        o = Fi({
          button: !0,
          "has-icon":
            this.loading || (!this.selected && e) || (this.selected && i),
          "has-end-icon": t,
        });
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${
        this.noRipple
    ...
    (e.Chip.styles = [Qi.styles, mo]),
    Se([zt({ reflect: !0 })], e.Chip.prototype, "variant", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Chip.prototype,
      "elevated",
    ...
    Se([zt({ reflect: !0 })], e.Chip.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "selected-icon" })],
      e.Chip.prototype,
      "selectedIcon",
    ...
    Se(
      [zt({ reflect: !0, attribute: "delete-icon" })],
      e.Chip.prototype,
      "deleteIcon",
      void 0
    ),
    Se([xi("selected", !0)], e.Chip.prototype, "onSelectedChange", null),
    (e.Chip = Se([_t("mdui-chip")], e.Chip));
  const fo = (e, t) => {
    ...
    vo = Pe`:host{display:block}`;
  (e.Collapse = class extends Jt {
    constructor() {
      super(...arguments),
        (this.accordion = !1),
        (this.disabled = !1),
        (this.activeKeys = []),
        (this.isInitial = !0),
        (this.definedController = new Ci(this, {
    ...
    setActiveKeys(e) {
      fo(this.activeKeys, e) || (this.activeKeys = e);
    }
    setValue(e) {
      this.accordion || u(this.value) || u(e)
        ? (this.value = e)
        : fo(this.value, e) || (this.value = e);
    }
    onClick(e) {
    ...
    Se([zt()], e.Collapse.prototype, "value", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Collapse.prototype,
      "disabled",
    ...
    Se([Nt()], e.Collapse.prototype, "activeKeys", void 0),
    Se(
      [Ft({ selector: "mdui-collapse-item", flatten: !0 })],
      e.Collapse.prototype,
      "items",
      void 0
    ),
    ...
    Se([xi("value")], e.Collapse.prototype, "onValueChange", null),
    (e.Collapse = Se([_t("mdui-collapse")], e.Collapse));
  const go = Pe`:host{display:flex;flex-direction:column}.header{display:block}.body{display:block;overflow:hidden;transition:height var(--mdui-motion-duration-short4) var(--mdui-motion-easing-emphasized)}.body.opened{overflow:visible}.body.active{transition-duration:var(--mdui-motion-duration-medium4)}`;
  function bo(e, t, i) {
    return e ? t(e) : i?.(e);
  }
  function yo(e, t, i) {
  ...
  (e.CollapseItem = class extends Jt {
    constructor() {
      super(...arguments),
        (this.disabled = !1),
        (this.active = !1),
    ...
    render() {
      return ft`<slot name="header" part="header" class="header">${
        this.header
      }</slot><slot part="body" class="body ${Gi({
        opened: "opened" === this.state,
        active: this.active,
      })}" ${Ni(this.bodyRef)} @transitionend="${
    ...
    updateBodyHeight() {
      ...
      "close" === this.state &&
        (M(this.bodyRef.value).height(e), this.bodyRef.value.clientLeft),
        M(this.bodyRef.value).height(
          "opened" === this.state ? "auto" : "open" === this.state ? e : 0
        );
    }
  }),
    (e.CollapseItem.styles = [ei, go]),
    Se([zt({ reflect: !0 })], e.CollapseItem.prototype, "value", void 0),
    Se([zt({ reflect: !0 })], e.CollapseItem.prototype, "header", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
    ...
    Se([zt()], e.CollapseItem.prototype, "trigger", void 0),
    Se([Nt()], e.CollapseItem.prototype, "active", void 0),
    Se([Nt()], e.CollapseItem.prototype, "state", void 0),
    Se([xi("active")], e.CollapseItem.prototype, "onActiveChange", null),
    (e.CollapseItem = Se([_t("mdui-collapse-item")], e.CollapseItem));
  let Co = [];
  class xo {
    constructor(e) {
    ...
    activate() {
      Co.push(this.element),
        document.addEventListener("focusin", this.handleFocusIn),
        document.addEventListener("keydown", this.handleKeyDown),
        document.addEventListener("keyup", this.handleKeyUp);
    }
    deactivate() {
      (Co = Co.filter((e) => e !== this.element)),
        document.removeEventListener("focusin", this.handleFocusIn),
        document.removeEventListener("keydown", this.handleKeyDown),
        document.removeEventListener("keyup", this.handleKeyUp);
    }
    isActive() {
      return Co[Co.length - 1] === this.element;
    }
    checkFocus() {
      if (this.isActive() && !this.element.matches(":focus-within")) {
        const { start: e, end: t } = (function (e) {
            ...
            return (
              ...
              {
                start: t.find((e) => ko(e)) ?? null,
                end: t.reverse().find((e) => ko(e)) ?? null,
              }
            );
          })(this.element),
  ...
  const So = (e) => {
      ...
      if (void 0 === Io) {
        ...
        i === o && (o = t[0].clientWidth), t.remove(), (Io = i - o);
      }
      return Io;
    },
    Eo = new WeakMap(),
    ...
    Do = (e, t) => {
      const i = n();
      (t ??= i.documentElement), Eo.has(t) || Eo.set(t, new Set());
      Eo.get(t).add(e);
      const o = M(t);
      ((e) => e.scrollHeight > e.clientHeight)(t) &&
        o.css("width", `calc(100% - ${So()}px)`),
        o.addClass(To);
    },
    Ao = (e, t) => {
      const i = n();
      ...
      o &&
        (o.delete(e),
        0 === o.size && (Eo.delete(t), M(t).removeClass(To).width("")));
    },
  ...
  const zo = [];
  for (let e = 0; e < 256; e++)
    zo[e] = ((e >> 4) & 15).toString(16) + (15 & e).toString(16);
  const No = "",
    Fo = "h",
    Vo = "s";
  function Ho(e, t) {
    ...
    if (e) {
      const o =
          ...
          (function (e) {
            ...
            let i = Ko.get(t);
            void 0 === i &&
              ((i = Ho(t, "string" != typeof e && !("strTag" in e))),
              Ko.set(t, i));
            return i;
          })(t),
        n = e[o];
      if (n) {
        ...
        if ("strTag" in n) return Po(n.strings, t.values, n.values);
        {
          let e = Uo.get(n);
          return (
            void 0 === e && ((e = n.values), Uo.set(n, e)),
  ...
  const tn = (e) => (
      (function (e) {
        if (Bo) throw new Error("lit-localize can only be configured once");
        (_o = e), (Bo = !0);
      })((e, t) => qo(Jo, e, t)),
      (Zo = Go = e.sourceLocale),
      (Yo = new Set(e.targetLocales)),
      Yo.add(e.sourceLocale),
      (Xo = e.loadLocale),
      { getLocale: on, setLocale: nn }
    ),
    on = () => Zo,
    nn = (e) => {
      if (e === (Wo ?? Zo)) return Qo.promise;
      if (!Yo || !Xo) throw new Error("Internal error");
      if (!Yo.has(e)) throw new Error("Invalid locale code");
      en++;
      const t = en;
      (Wo = e),
        Qo.settled && (Qo = new Oo()),
        jo({ status: "loading", loadingLocale: e });
      return (
        (e === Go ? Promise.resolve({ templates: void 0 }) : Xo(e)).then(
          (i) => {
            en === t &&
              ((Zo = e),
              (Wo = void 0),
              (Jo = i.templates),
              jo({ status: "ready", readyLocale: e }),
              Qo.resolve());
          },
          (i) => {
            en === t &&
    ...
    sn = "You must call `loadLocale` first to set up the localized template.";
  let an, ln;
  let cn = !1;
  const dn = new Map(),
    hn = (e, t) => {
  ...
  (e.Dialog = class extends Jt {
    ...
    async onOpenChange() {
      ...
      const t = Array.from(
          this.panelRef.value.querySelectorAll(".header, .body, .actions")
        ),
        i = $o(this, "linear"),
        o = $o(this, "emphasized-decelerate"),
        n = $o(this, "emphasized-accelerate"),
        r = () =>
          Promise.all([
            wo(this.overlayRef.value),
            wo(this.panelRef.value),
            ...t.map((e) => wo(e)),
          ]);
      if (this.open) {
        if (e) {
        ...
        const e = Ro(this, "short4");
        await Promise.all([
          yo(this.overlayRef.value, [{ opacity: 1 }, { opacity: 0 }], {
            duration: e,
            easing: i,
          }),
          yo(
    ...
    disconnectedCallback() {
      super.disconnectedCallback(), Ao(this), un(this);
    }
    firstUpdated(e) {
      super.firstUpdated(e),
        (this.modalHelper = new xo(this)),
    ...
    render() {
      ...
      return ft`<div ${Ni(
        ...
        this.onOverlayClick
      }" tabindex="-1"></div><div ${Ni(
        this.panelRef
      )} part="panel" class="panel ${Gi({
        "has-icon": i,
        "has-description": n,
        "has-default": t,
      })}" tabindex="0">${bo(
        r,
        () =>
          ft`<slot name="header" part="header" class="header">${bo(i, () =>
            this.renderIcon()
          )} ${bo(o, () => this.renderHeadline())}</slot>`
      )} ${bo(
        s,
        () =>
          ft`<div ${Ni(this.bodyRef)} part="body" class="body">${bo(n, () =>
    ...
    (e.Dialog.styles = [ei, pn]),
    Se([zt({ reflect: !0 })], e.Dialog.prototype, "icon", void 0),
    Se([zt({ reflect: !0 })], e.Dialog.prototype, "headline", void 0),
    Se([zt({ reflect: !0 })], e.Dialog.prototype, "description", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Dialog.prototype,
      "open",
    ...
    Se(
      [Ft({ slot: "header", selector: "mdui-top-app-bar", flatten: !0 })],
      e.Dialog.prototype,
      "topAppBarElements",
      void 0
    ),
    Se([xi("open")], e.Dialog.prototype, "onOpenChange", null),
    (e.Dialog = Se([_t("mdui-dialog")], e.Dialog));
  const mn = Pe`:host{display:block;height:.0625rem;background-color:rgb(var(--mdui-color-surface-variant))}:host([inset]:not([inset=false i])){margin-left:1rem}:host([middle]:not([middle=false i])){margin-left:1rem;margin-right:1rem}:host([vertical]:not([vertical=false i])){height:100%;width:.0625rem}`;
  function fn() {
  ...
  function bn(e) {
    return !!fn() && (e instanceof Node || e instanceof gn(e).Node);
  }
  function yn(e) {
    return (
      !(!fn() || "undefined" == typeof ShadowRoot) &&
  ...
  function kn(e) {
    ...
    const t =
      ...
      (function (e) {
        var t;
        return null ==
          (t = (bn(e) ? e.ownerDocument : e.document) || window.document)
          ? void 0
          : t.documentElement;
      })(e);
  ...
  function Cn(e) {
    ...
    return (function (e) {
      ...
      : ((i = t),
        fn() &&
        (i instanceof HTMLElement || i instanceof gn(i).HTMLElement) &&
        wn(t)
          ? t
          : Cn(t));
    var i;
  ...
  function xn(e, t, i) {
    ...
    return t.concat(n, xn(n, [], i));
  }
  (e.Divider = class extends Jt {
    constructor() {
      super(...arguments),
        (this.vertical = !1),
        (this.inset = !1),
    ...
    (e.Divider = Se([_t("mdui-divider")], e.Divider));
  const $n = Pe`:host{--z-index:2100;display:contents}.panel{display:block;position:fixed;z-index:var(--z-index)}`;
  (e.Dropdown = class extends Jt {
    constructor() {
      super(),
        (this.open = !1),
        (this.disabled = !1),
        ...
        (this.panelRef = Bi()),
        (this.definedController = new Ci(this, { relatedElements: [""] })),
    ...
    async onPositionChange() {
      this.open &&
        (await this.definedController.whenDefined(), this.updatePositioner());
    }
    async onOpenChange() {
      const e = this.hasUpdated;
      if (!this.open && !e) return;
      await this.definedController.whenDefined(),
        e || (await this.updateComplete);
      const t = $o(this, "linear"),
        i = $o(this, "emphasized-decelerate"),
        o = $o(this, "emphasized-accelerate");
      if (this.open) {
        if (e) {
          if (!this.emit("open", { cancelable: !0 })) return;
        }
        ...
        const n = Ro(this, "medium4");
        await wo(this.panelRef.value),
      ...
      super.connectedCallback(),
        this.definedController.whenDefined().then(() => {
          document.addEventListener("pointerdown", this.onDocumentClick),
            ...
            (this.overflowAncestors = xn(this.triggerElement)),
            this.overflowAncestors.forEach((e) => {
              e.addEventListener("scroll", this.onWindowScroll);
            }),
            (this.observeResize = Di(this.triggerElement, () => {
              this.updatePositioner();
            }));
        });
    }
    ...
    render() {
      return ft`<slot name="trigger" part="trigger" class="trigger"></slot><slot ${Ni(
        this.panelRef
    ...
    Se([zt({ reflect: !0 })], e.Dropdown.prototype, "trigger", void 0),
    Se([zt({ reflect: !0 })], e.Dropdown.prototype, "placement", void 0),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se(
      [zt({ type: Number, reflect: !0, attribute: "open-delay" })],
      e.Dropdown.prototype,
      "openDelay",
      void 0
    ),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "close-delay" })],
      e.Dropdown.prototype,
      "closeDelay",
      void 0
    ),
    ...
    Se(
      [Ft({ slot: "trigger", flatten: !0 })],
      e.Dropdown.prototype,
      "triggerElements",
      void 0
    ),
    Se([Ft({ flatten: !0 })], e.Dropdown.prototype, "panelElements", void 0),
    Se(
      [xi("placement", !0), xi("openOnPointer", !0)],
      e.Dropdown.prototype,
      "onPositionChange",
      null
    ),
    Se([xi("open")], e.Dropdown.prototype, "onOpenChange", null),
    (e.Dropdown = Se([_t("mdui-dropdown")], e.Dropdown));
  const Rn = (e = 0) => new Promise((t) => setTimeout(t, e)),
  ...
  (e.Fab = class extends Qi {
    constructor() {
      super(...arguments),
        ...
        (this.extended = !1),
        (this.rippleRef = Bi()),
        (this.hasSlotController = new Zt(this, "icon")),
        (this.definedController = new Ci(this, { relatedElements: [""] }));
    }
    get rippleElement() {
      return this.rippleRef.value;
    ...
    (e.Fab.styles = [Qi.styles, In]),
    Se([zt({ reflect: !0 })], e.Fab.prototype, "variant", void 0),
    Se([zt({ reflect: !0 })], e.Fab.prototype, "size", void 0),
    Se([zt({ reflect: !0 })], e.Fab.prototype, "icon", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Fab.prototype,
      "extended",
    ...
    Se([xi("extended")], e.Fab.prototype, "onExtendedChange", null),
    (e.Fab = Se([_t("mdui-fab")], e.Fab));
  const Sn = Pe`:host{position:relative;display:flex;flex:1 1 auto;overflow:hidden}:host([full-height]:not([full-height=false i])){height:100%}`;
  (e.Layout = class extends Jt {
    constructor() {
    ...
    (e.Layout = Se([_t("mdui-layout")], e.Layout));
  const En = Pe`:host{display:flex;z-index:1}`;
  (e.LayoutItem = class extends Li {
    constructor() {
    ...
    (e.LayoutItem.styles = [ei, En]),
    Se([zt({ reflect: !0 })], e.LayoutItem.prototype, "placement", void 0),
    Se(
      [xi("placement", !0)],
    ...
    (e.LayoutItem = Se([_t("mdui-layout-item")], e.LayoutItem));
  const Tn = Pe`:host{flex:1 0 auto;max-width:100%;overflow:auto}`;
  (e.LayoutMain = class extends Jt {
    connectedCallback() {
      super.connectedCallback();
      const e = this.parentElement;
      a(e, "mdui-layout") &&
        ((this.layoutManager = Pi(e)), this.layoutManager.registerMain(this));
    }
    disconnectedCallback() {
      super.disconnectedCallback(),
  ...
  (e.LinearProgress = class extends Jt {
    ...
    render() {
      if (!u(this.value)) {
        const e = this.value;
        return ft`<div part="indicator" class="determinate" style="${Xt({
  ...
  (e.ListItem = class extends Ki(Ji(Wi(Jt))) {
    constructor() {
      super(...arguments),
        (this.disabled = !1),
        (this.active = !1),
    ...
    render() {
      const e = (e) =>
          a(e, "mdui-icon") ||
          ((e) => e?.nodeName.toLowerCase() ?? "")(e).startsWith("mdui-icon-"),
        t = Fi({
          container: !0,
          ...
          "is-icon": e(this.iconElements[0]),
          "is-end-icon": e(this.endIconElements[0]),
        });
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${
        this.noRipple
      }"></mdui-ripple>${
        this.href && !this.disabled
          ? this.renderAnchor({
              ...
              content: this.renderInner(),
              part: "container",
              refDirective: Ni(this.itemRef),
            })
          : ft`<div part="container" class="${t}" ${Ni(
              this.itemRef
    ...
    (e.ListItem.styles = [ei, An]),
    Se([zt({ reflect: !0 })], e.ListItem.prototype, "headline", void 0),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "headline-line" })],
      e.ListItem.prototype,
      "headlineLine",
      void 0
    ),
    Se([zt({ reflect: !0 })], e.ListItem.prototype, "description", void 0),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "description-line" })],
      e.ListItem.prototype,
      "descriptionLine",
      void 0
    ),
    Se([zt({ reflect: !0 })], e.ListItem.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "end-icon" })],
      e.ListItem.prototype,
      "endIcon",
    ...
    Se([zt({ reflect: !0 })], e.ListItem.prototype, "alignment", void 0),
    Se(
      [Ft({ slot: "icon", flatten: !0 })],
      e.ListItem.prototype,
      "iconElements",
      void 0
    ),
    Se(
      [Ft({ slot: "end-icon", flatten: !0 })],
      e.ListItem.prototype,
      "endIconElements",
      void 0
    ),
    (e.ListItem = Se([_t("mdui-list-item")], e.ListItem));
  ...
  (e.MenuItem = class extends Ki(Ji(Wi(Jt))) {
    ...
    async onOpenChange() {
      ...
      if (this.submenuOpen) {
        ...
        const o = Ro(this, "medium4");
        await wo(this.submenuRef.value),
      ...
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${
        ...
        this.href && !this.disabled
          ? this.renderAnchor({
              ...
              refDirective: Ni(this.containerRef),
              tabIndex: this.focusable ? 0 : -1,
            })
          : ft`<div part="container" ${Ni(
              this.containerRef
            )} class="${a}">${this.renderInner(o, r)}</div>`
      } ${bo(
        e,
        () =>
          ft`<slot name="submenu" ${Ni(
            this.submenuRef
    ...
    hasTrigger(e) {
      return (
        !!this.submenuTrigger && this.submenuTrigger.split(" ").includes(e)
      );
    }
    onFocus() {
      !this.disabled &&
    ...
    renderInner(e, t) {
      return ft`<slot name="custom">${
        this.selected
          ...
          : ft`<slot name="icon" part="icon" class="icon">${
              t ? ft`<mdui-icon name="${this.icon}" class="i"></mdui-icon>` : Qt
            }</slot>`
    ...
    (e.MenuItem.styles = [ei, _n]),
    Se([zt({ reflect: !0 })], e.MenuItem.prototype, "value", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
    ...
    Se([zt({ reflect: !0 })], e.MenuItem.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "end-icon" })],
      e.MenuItem.prototype,
      "endIcon",
    ...
    Se(
      [zt({ reflect: !0, attribute: "end-text" })],
      e.MenuItem.prototype,
      "endText",
      void 0
    ),
    ...
    Se([Nt()], e.MenuItem.prototype, "dense", void 0),
    Se([Nt()], e.MenuItem.prototype, "selects", void 0),
    Se([Nt()], e.MenuItem.prototype, "submenuTrigger", void 0),
    Se([Nt()], e.MenuItem.prototype, "submenuOpenDelay", void 0),
    Se([Nt()], e.MenuItem.prototype, "submenuCloseDelay", void 0),
    Se([Nt()], e.MenuItem.prototype, "focusable", void 0),
    Se([xi("submenuOpen")], e.MenuItem.prototype, "onOpenChange", null),
    (e.MenuItem = Se([_t("mdui-menu-item")], e.MenuItem));
  ...
  (e.Menu = class extends Jt {
    ...
    setSelectedKeys(e) {
      fo(this.selectedKeys, e) || (this.selectedKeys = e);
    }
    setValue(e) {
    ...
    async focusableOne(e) {
      this.items.forEach((t) => (t.focusable = t.key === e.key)), await Rn();
    }
    focusOne(e, t) {
      e.focus(t);
    }
    ...
    (e.Menu.styles = [ei, Bn]),
    Se([zt({ reflect: !0 })], e.Menu.prototype, "selects", void 0),
    Se([zt()], e.Menu.prototype, "value", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Menu.prototype,
      "dense",
    ...
    Se(
      [zt({ reflect: !0, attribute: "submenu-trigger" })],
      e.Menu.prototype,
      "submenuTrigger",
      void 0
    ),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "submenu-open-delay" })],
      e.Menu.prototype,
      "submenuOpenDelay",
      void 0
    ),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "submenu-close-delay" })],
      e.Menu.prototype,
      "submenuCloseDelay",
      void 0
    ),
    Se([Nt()], e.Menu.prototype, "selectedKeys", void 0),
    Se(
      [Ft({ flatten: !0, selector: "mdui-menu-item" })],
      e.Menu.prototype,
      "childrenItems",
      void 0
    ),
    Se(
      [
        ...
        xi("submenuTrigger"),
        xi("submenuOpenDelay"),
        xi("submenuCloseDelay"),
      ],
      e.Menu.prototype,
      "onSlotChange",
      null
    ),
    Se([xi("selects", !0)], e.Menu.prototype, "onSelectsChange", null),
    Se(
      [xi("selectedKeys", !0)],
      e.Menu.prototype,
  ...
  (e.NavigationBarItem = class extends Ki(Ji(Wi(Jt))) {
    constructor() {
      super(...arguments),
        ...
        (this.key = Si()),
        (this.rippleRef = Bi()),
        (this.hasSlotController = new Zt(this, "active-icon"));
    }
    get rippleElement() {
      return this.rippleRef.value;
    }
    ...
    render() {
      ...
      }" class="${e}" ${Ni(this.rippleRef)}></mdui-ripple>${
        this.href
          ? this.renderAnchor({
              part: "container",
              className: t,
    ...
    (e.NavigationBarItem.styles = [ei, On]),
    Se([zt({ reflect: !0 })], e.NavigationBarItem.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "active-icon" })],
      e.NavigationBarItem.prototype,
      "activeIcon",
      void 0
    ),
    Se([zt({ reflect: !0 })], e.NavigationBarItem.prototype, "value", void 0),
    Se([Nt()], e.NavigationBarItem.prototype, "labelVisibility", void 0),
    Se([Nt()], e.NavigationBarItem.prototype, "isInitial", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.NavigationBarItem.prototype,
      "active",
    ...
    Se([Nt()], e.NavigationBarItem.prototype, "disabled", void 0),
    (e.NavigationBarItem = Se(
      [_t("mdui-navigation-bar-item")],
      e.NavigationBarItem
    ));
  ...
  (e.NavigationBar = class extends Ri(Li) {
    constructor() {
      super(...arguments),
        (this.hide = !1),
    ...
    onClick(e) {
      ...
      t &&
        ((this.activeKey = t.key), (this.isInitial = !1), this.updateItems());
    }
    updateItems() {
      const e = this.items,
        t =
    ...
    Se(
      [zt({ reflect: !0, attribute: "label-visibility" })],
      e.NavigationBar.prototype,
      "labelVisibility",
      void 0
    ),
    Se([zt({ reflect: !0 })], e.NavigationBar.prototype, "value", void 0),
    Se(
      [zt({ reflect: !0, attribute: "scroll-behavior" })],
      e.NavigationBar.prototype,
      "scrollBehavior",
    ...
    Se([Nt()], e.NavigationBar.prototype, "activeKey", void 0),
    Se(
      [Ft({ selector: "mdui-navigation-bar-item", flatten: !0 })],
      e.NavigationBar.prototype,
      "items",
      void 0
    ),
    ...
    Se([xi("value")], e.NavigationBar.prototype, "onValueChange", null),
    Se(
      [xi("labelVisibility", !0)],
      e.NavigationBar.prototype,
      "onLabelVisibilityChange",
      null
    ),
    (e.NavigationBar = Se([_t("mdui-navigation-bar")], e.NavigationBar));
  const Nn = (e) => {
      const t = s(),
        i = n(),
  ...
  (e.NavigationDrawer = class extends Li {
    constructor() {
      super(...arguments),
        (this.open = !1),
        (this.modal = !1),
        ...
        (this.overlayRef = Bi()),
        (this.panelRef = Bi()),
        (this.definedController = new Ci(this, { needDomReady: !0 }));
    }
    get layoutPlacement() {
      return this.placement;
    }
    ...
    async onMobileChange() {
      !this.open ||
        ...
        (await this.definedController.whenDefined(),
        this.isModal
          ? (Do(this, this.lockTarget), await this.getLockTargetAnimate(!1, 0))
          : (Ao(this, this.lockTarget),
      ...
      const i = "right" === this.placement,
        ...
        s = async () => {
          ...
          this.isModal || i.includes(this) || i.push(this),
            await Promise.all(i.map((e) => wo(e)));
        };
      if (this.open) {
        ...
        await this.definedController.whenDefined(),
          ...
          await s();
        const a = Ro(this, "short4"),
          c = [];
        if (
          (this.isModal
            ? c.push(
                yo(t, [{ opacity: 1 }, { opacity: 0 }], {
                  duration: a,
                  easing: o,
                })
              )
          ...
          this.isParentLayout &&
            (r(a, n), this.layoutManager.updateLayout(this, { width: 0 })),
          c.push(
            yo(
              this.isModal ? e : this,
              [
        ...
        this.isParentLayout && r(null),
          (this.style.display = "none"),
          this.isModal && !this.contained && Ao(this, this.lockTarget);
    ...
    getLockTargetAnimate(e, t) {
      ...
      return yo(this.lockTarget, [{ [i]: e ? 0 : o }, { [i]: e ? o : 0 }], {
        duration: t,
        easing: $o(this, "emphasized"),
        fill: "forwards",
      });
    }
  }),
    (e.NavigationDrawer.styles = [ei, Fn]),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
  ...
  (e.NavigationRail = class extends Li {
    constructor() {
      super(...arguments),
        ...
        (this.divider = !1),
        (this.activeKey = 0),
        (this.hasSlotController = new Zt(this, "top", "bottom")),
        (this.definedController = new Ci(this, {
    ...
    async onContainedChange() {
      this.isParentLayout ||
        ...
        M(document.body).css({
          paddingLeft:
            this.contained || this.isRight ? null : this.paddingValue,
          paddingRight:
            this.contained || !this.isRight ? null : this.paddingValue,
        }),
        M(this.parentElement).css({
          paddingLeft:
            this.contained && !this.isRight ? this.paddingValue : null,
          paddingRight:
            this.contained && this.isRight ? this.paddingValue : null,
        }));
    }
    ...
    render() {
      ...
      return ft`${bo(
        ...
        this.onClick
      }"></slot><span class="bottom-spacer"></span> ${bo(
        t,
    ...
    (e.NavigationRail.styles = [ei, Vn]),
    Se([zt({ reflect: !0 })], e.NavigationRail.prototype, "value", void 0),
    Se([zt({ reflect: !0 })], e.NavigationRail.prototype, "placement", void 0),
    Se([zt({ reflect: !0 })], e.NavigationRail.prototype, "alignment", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
    ...
    Se([Nt()], e.NavigationRail.prototype, "activeKey", void 0),
    Se(
      [Ft({ selector: "mdui-navigation-rail-item", flatten: !0 })],
      e.NavigationRail.prototype,
      "items",
      void 0
    ),
    ...
    Se([xi("value")], e.NavigationRail.prototype, "onValueChange", null),
    Se(
      [xi("contained", !0)],
      e.NavigationRail.prototype,
      "onContainedChange",
  ...
  (e.NavigationRailItem = class extends Ki(Ji(Wi(Jt))) {
    constructor() {
      super(...arguments),
        ...
        (this.key = Si()),
        (this.rippleRef = Bi()),
        (this.hasSlotController = new Zt(this, "[default]", "active-icon"));
    }
    get rippleElement() {
      return this.rippleRef.value;
    }
    ...
    render() {
      ...
      }<mdui-ripple .noRipple="${!this.active || this.noRipple}" ${Ni(
        this.rippleRef
      )}></mdui-ripple>`;
    }
    renderInner(e) {
      return ft`<div part="indicator" class="indicator"><slot name="badge" part="badge" class="${Gi(
    ...
    (e.NavigationRailItem.styles = [ei, Hn]),
    Se([zt({ reflect: !0 })], e.NavigationRailItem.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "active-icon" })],
    ...
    Se([zt({ reflect: !0 })], e.NavigationRailItem.prototype, "value", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.NavigationRailItem.prototype,
      "active",
    ...
    Se([Nt()], e.NavigationRailItem.prototype, "isInitial", void 0),
    Se([Nt()], e.NavigationRailItem.prototype, "placement", void 0),
    Se([Nt()], e.NavigationRailItem.prototype, "disabled", void 0),
    (e.NavigationRailItem = Se(
      [_t("mdui-navigation-rail-item")],
  ...
  (Un.styles = ro), (Un = Se([_t("mdui-icon-circle")], Un));
  ...
  (Kn.styles = ro), (Kn = Se([_t("mdui-icon-radio-button-unchecked")], Kn));
  ...
  (e.Radio = class extends Ji(Wi(Jt)) {
    constructor() {
      super(...arguments),
        (this.value = ""),
        (this.disabled = !1),
    ...
    render() {
      const e = Gi({ invalid: this.invalid, initial: this.isInitial });
      return ft`<i part="control" class="${e}"><mdui-ripple ${Ni(
        this.rippleRef
      )} .noRipple="${
        this.noRipple
      }"></mdui-ripple><slot name="unchecked-icon" part="unchecked-icon" class="icon unchecked-icon">${
    ...
    (e.Radio.styles = [ei, qn]),
    Se([zt({ reflect: !0 })], e.Radio.prototype, "value", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Radio.prototype,
      "disabled",
    ...
    Se([Nt()], e.Radio.prototype, "invalid", void 0),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se([Nt()], e.Radio.prototype, "focusable", void 0),
    Se([Nt()], e.Radio.prototype, "isInitial", void 0),
    Se([xi("checked", !0)], e.Radio.prototype, "onCheckedChange", null),
    (e.Radio = Se([_t("mdui-radio")], e.Radio));
  const jn = Pe`:host{display:inline-block}fieldset{border:none;padding:0;margin:0;min-width:0}input{position:absolute;padding:0;opacity:0;pointer-events:none;width:1.25rem;height:1.25rem;margin:0 0 0 .625rem}`;
  function* Wn(e, t) {
    if (void 0 !== e) {
      let i = 0;
  ...
  (e.RadioGroup = class extends Jt {
    ...
    render() {
      return ft`<fieldset><input ${Ni(
        this.inputRef
      )} type="radio" class="input" name="${Vt(this.name)}" value="${Vt(
        this.value
    ...
    Se([zt({ reflect: !0 })], e.RadioGroup.prototype, "form", void 0),
    Se([zt({ reflect: !0 })], e.RadioGroup.prototype, "name", void 0),
    Se([zt({ reflect: !0 })], e.RadioGroup.prototype, "value", void 0),
    Se([no()], e.RadioGroup.prototype, "defaultValue", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.RadioGroup.prototype,
      "required",
  ...
  class Yn extends Ji(Wi(Jt)) {
    ...
    renderLabel(e) {
      return bo(
        !this.nolabel,
        () =>
          ft`<div part="label" class="label ${Gi({
  ...
  (Yn.styles = [ei, Gn]),
    Se([zt({ type: Number, reflect: !0 })], Yn.prototype, "min", void 0),
    Se([zt({ type: Number, reflect: !0 })], Yn.prototype, "max", void 0),
    Se([zt({ type: Number, reflect: !0 })], Yn.prototype, "step", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      Yn.prototype,
      "tickmarks",
    ...
    Se([zt({ reflect: !0 })], Yn.prototype, "form", void 0),
    Se([zt({ reflect: !0 })], Yn.prototype, "name", void 0),
    Se([Nt()], Yn.prototype, "invalid", void 0),
    Se([Nt()], Yn.prototype, "labelVisible", void 0),
    Se([zt({ attribute: !1 })], Yn.prototype, "labelFormatter", void 0),
    Se([xi("disabled", !0)], Yn.prototype, "onDisabledChange", null),
    (e.RangeSlider = class extends Yn {
      constructor() {
        super(...arguments),
          (this.defaultValue = []),
          (this.currentHandle = "start"),
          (this.rippleStartRef = Bi()),
          (this.rippleEndRef = Bi()),
          (this.handleStartRef = Bi()),
          (this.handleEndRef = Bi()),
          (this.formController = new Ui(this)),
          (this._value = []),
          (this.getRippleIndex = () =>
            this.hoverHandle
      ...
      render() {
        return ft`<label class="${Gi({ invalid: this.invalid })}"><input ${Ni(
          this.inputRef
        )} type="range" step="${this.step}" min="${this.min}" max="${
          this.max
        }" ?disabled="${this.disabled}" @input="${this.onInput}" @change="${
          this.onChange
        }"><div part="track-inactive" class="track-inactive"></div><div ${Ni(
          this.trackActiveRef
        )} part="track-active" class="track-active"></div><div ${Ni(
          this.handleStartRef
        )} part="handle" class="handle start" style="${Xt({
          "z-index": "start" === this.currentHandle ? "2" : "1",
        })}"><div class="elevation"></div><mdui-ripple ${Ni(
          this.rippleStartRef
        )} .noRipple="${this.noRipple}"></mdui-ripple>${this.renderLabel(
          this.value[0]
        )}</div><div ${Ni(
          this.handleEndRef
        )} part="handle" class="handle end" style="${Xt({
          "z-index": "end" === this.currentHandle ? "2" : "1",
        })}"><div class="elevation"></div><mdui-ripple ${Ni(
          this.rippleEndRef
        )} .noRipple="${this.noRipple}"></mdui-ripple>${this.renderLabel(
          this.value[1]
        )}</div>${bo(this.tickmarks, () =>
          Wn(
            this.getCandidateValues(),
            (e) =>
              ft`<div part="tickmark" class="tickmark ${Gi({
                active: e > this.value[0] && e < this.value[1],
              })}" style="${Xt({
                left: ((e - this.min) / this.max) * 100 + "%",
                display:
                  e === this.value[0] || e === this.value[1] ? "none" : "block",
              })}"></div>`
          )
        )}</label>`;
      }
  ...
  (e.SegmentedButton = class extends Qi {
    constructor() {
      super(...arguments),
        (this.selected = !1),
        (this.invalid = !1),
    ...
    (e.SegmentedButton.styles = [Qi.styles, Xn]),
    Se([zt({ reflect: !0 })], e.SegmentedButton.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "end-icon" })],
  ...
  (e.SegmentedButtonGroup = class extends Jt {
    ...
    render() {
      return ft`${bo(
        ...
        () =>
          ft`<input ${Ni(this.inputRef)} type="radio" name="${Vt(
            this.name
        ...
        () =>
          ft`<select ${Ni(this.inputRef)} name="${Vt(this.name)}" .disabled="${
            this.disabled
          }" .required="${
            this.required
    ...
    async onInputKeyDown(e) {
      if (["Enter", " "].includes(e.key)) {
        ...
        this.isMultiple &&
          (this.selectOne(this.itemsEnabled[0]), this.itemsEnabled[0].focus());
      }
    }
    async onSlotChange() {
    ...
    setValue(e) {
      this.isSingle ? (this.value = e) : fo(this.value, e) || (this.value = e);
    }
    updateItems(e = !1) {
      const t = this.items;
      t.forEach((i, o) => {
    ...
    (e.SegmentedButtonGroup.styles = [ei, Jn]),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se([zt({ reflect: !0 })], e.SegmentedButtonGroup.prototype, "form", void 0),
    Se([zt({ reflect: !0 })], e.SegmentedButtonGroup.prototype, "name", void 0),
    Se([zt()], e.SegmentedButtonGroup.prototype, "value", void 0),
    Se([no()], e.SegmentedButtonGroup.prototype, "defaultValue", void 0),
    Se([Nt()], e.SegmentedButtonGroup.prototype, "selectedKeys", void 0),
    Se([Nt()], e.SegmentedButtonGroup.prototype, "invalid", void 0),
    Se(
      [xi("selects", !0)],
      e.SegmentedButtonGroup.prototype,
      "onSelectsChange",
    ...
    Se([xi("value")], e.SegmentedButtonGroup.prototype, "onValueChange", null),
    Se(
      [xi("invalid", !0), xi("disabled")],
      e.SegmentedButtonGroup.prototype,
      "onInvalidChange",
    ...
    (e.SegmentedButtonGroup = Se(
      [_t("mdui-segmented-button-group")],
  ...
  (Zn.styles = ro), (Zn = Se([_t("mdui-icon-cancel--outlined")], Zn));
  ...
  (Qn.styles = ro), (Qn = Se([_t("mdui-icon-error")], Qn));
  ...
  (er.styles = ro), (er = Se([_t("mdui-icon-visibility-off")], er));
  ...
  (e.TextField = class extends Wi(Jt) {
    ...
    async onValueChange() {
      if (
        ((this.hasValue = !["", null].includes(this.value)), this.hasUpdated)
      ) {
    ...
    connectedCallback() {
      super.connectedCallback(),
        this.updateComplete.then(() => {
          this.setTextareaHeight(),
            (this.observeResize = Di(this.inputRef.value, () =>
              this.setTextareaHeight()
            ));
        });
    }
    disconnectedCallback() {
      super.disconnectedCallback(), this.observeResize?.unobserve(), un(this);
    }
    select() {
    ...
    setCustomValidity(e) {
      this.setCustomValidityInternal(e), un(this);
    }
    render() {
      const e = !!this.icon || this.hasSlotController.test("icon"),
        t = !!this.endIcon || this.hasSlotController.test("end-icon"),
      ...
      return ft`<div part="container" class="${u}">${this.renderPrefix()}<div class="input-container">${this.renderLabel()} ${
        ...
        l || a || c,
        () =>
          ft`<div part="supporting" class="${Gi({
            supporting: !0,
            ...h,
          })}">${this.renderHelper(l, a)} ${this.renderCounter(c)}</div>`
      )}`;
    }
    ...
    onTextAreaKeyUp() {
      if (this.pattern) {
        ...
        this.value && !this.value.match(e)
          ...
          : (this.setCustomValidityInternal(""), un(this));
      }
    }
    onTogglePassword() {
    ...
    getPatternErrorMsg() {
      return _o("Please match the requested format.", {
    ...
    renderInput(e) {
      return ft`<input ${Ni(this.inputRef)} part="input" class="input ${Gi({
        "hide-input": e,
      })}" type="${
        "password" === this.type && this.isPasswordVisible ? "text" : this.type
      }" name="${Vt(this.name)}" .value="${oo(this.value)}" placeholder="${Vt(
        !this.label || this.isFocusedStyle || this.hasValue
          ? this.placeholder
          : void 0
      )}" ?readonly="${this.readonly}" ?disabled="${
        this.disabled
      }" ?required="${this.required}" minlength="${Vt(
        this.minlength
      )}" maxlength="${Vt(this.maxlength)}" min="${Vt(this.min)}" max="${Vt(
        this.max
      )}" step="${Vt(this.step)}" autocapitalize="${Vt(
        "password" === this.type ? "off" : this.autocapitalize
      )}" autocomplete="${this.autocomplete}" autocorrect="${Vt(
        "password" === this.type ? "off" : this.autocorrect
      )}" spellcheck="${Vt(this.spellcheck)}" pattern="${Vt(
        this.pattern
      )}" enterkeyhint="${Vt(this.enterkeyhint)}" inputmode="${Vt(
        this.inputmode
    ...
    renderTextArea(e) {
      return ft`<textarea ${Ni(this.inputRef)} part="input" class="input ${Gi({
        "hide-input": e,
      })}" name="${Vt(this.name)}" .value="${oo(this.value)}" placeholder="${Vt(
        !this.label || this.isFocusedStyle || this.hasValue
          ? this.placeholder
        ...
        this.minlength
      )}" maxlength="${Vt(this.maxlength)}" rows="${
        this.rows ?? 1
      }" autocapitalize="${Vt(this.autocapitalize)}" autocorrect="${Vt(
        this.autocorrect
      )}" spellcheck="${Vt(this.spellcheck)}" enterkeyhint="${Vt(
        this.enterkeyhint
      )}" inputmode="${Vt(this.inputmode)}" @change="${
        this.onChange
      }" @input="${this.onInput}" @invalid="${this.onInvalid}" @keydown="${
        this.onKeyDown
    ...
    (e.TextField.styles = [ei, ir]),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "variant", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "type", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "name", void 0),
    Se([zt()], e.TextField.prototype, "value", void 0),
    Se([no()], e.TextField.prototype, "defaultValue", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "label", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "placeholder", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "helper", void 0),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se(
      [zt({ reflect: !0, attribute: "clear-icon" })],
      e.TextField.prototype,
      "clearIcon",
      void 0
    ),
    ...
    Se([zt({ reflect: !0 })], e.TextField.prototype, "prefix", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "suffix", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "end-icon" })],
      e.TextField.prototype,
      "endIcon",
    ...
    Se(
      [zt({ reflect: !0, attribute: "error-icon" })],
      e.TextField.prototype,
      "errorIcon",
      void 0
    ),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "form", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.TextField.prototype,
      "readonly",
    ...
    Se(
      [zt({ type: Number, reflect: !0, attribute: "min-rows" })],
      e.TextField.prototype,
      "minRows",
      void 0
    ),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "max-rows" })],
      e.TextField.prototype,
      "maxRows",
      void 0
    ),
    ...
    Se([zt({ reflect: !0 })], e.TextField.prototype, "pattern", void 0),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se(
      [zt({ reflect: !0, attribute: "show-password-icon" })],
      e.TextField.prototype,
      "showPasswordIcon",
      void 0
    ),
    Se(
      [zt({ reflect: !0, attribute: "hide-password-icon" })],
      e.TextField.prototype,
      "hidePasswordIcon",
      void 0
    ),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "autocapitalize", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "autocorrect", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "autocomplete", void 0),
    Se([zt({ reflect: !0 })], e.TextField.prototype, "enterkeyhint", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.TextField.prototype,
      "spellcheck",
    ...
    Se([zt({ reflect: !0 })], e.TextField.prototype, "inputmode", void 0),
    Se([Nt()], e.TextField.prototype, "invalid", void 0),
    Se([Nt()], e.TextField.prototype, "invalidStyle", void 0),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se([Nt()], e.TextField.prototype, "isPasswordVisible", void 0),
    Se([Nt()], e.TextField.prototype, "hasValue", void 0),
    Se([Nt()], e.TextField.prototype, "error", void 0),
    Se([xi("disabled", !0)], e.TextField.prototype, "onDisabledChange", null),
    Se([xi("value")], e.TextField.prototype, "onValueChange", null),
    Se([xi("rows", !0)], e.TextField.prototype, "onRowsChange", null),
    Se([xi("maxRows")], e.TextField.prototype, "onMaxRowsChange", null),
    Se([xi("minRows")], e.TextField.prototype, "onMinRowsChange", null),
    (e.TextField = Se([_t("mdui-text-field")], e.TextField));
  const or = Pe`:host{display:inline-block;width:100%}.hidden-input{display:none}.text-field{cursor:pointer}.chips{display:flex;flex-wrap:wrap;margin:-.5rem -.25rem;min-height:2.5rem}:host([variant=filled][label]) .chips{margin:0 -.25rem -1rem -.25rem}.chip{margin:.25rem}mdui-menu{max-width:none}`;
  (e.Select = class extends Wi(Jt) {
    constructor() {
      super(...arguments),
        (this.variant = "filled"),
        (this.multiple = !1),
        ...
        (this.invalid = !1),
        (this.menuRef = Bi()),
        (this.textFieldRef = Bi()),
        (this.hiddenInputRef = Bi()),
        (this.formController = new Ui(this)),
        (this.hasSlotController = new Zt(
          this,
          "icon",
    ...
    connectedCallback() {
      super.connectedCallback(),
        ...
        this.updateComplete.then(() => {
          this.observeResize = Di(this.textFieldRef.value, () =>
            this.resizeMenu()
          );
        });
    }
    ...
    render() {
      ...
      return ft`${
        this.multiple
          ? ft`<select ${Ni(
              this.hiddenInputRef
            )} class="hidden-input" name="${Vt(this.name)}" value="${Vt(
              this.value
            )}" .required="${this.required}" .disabled="${
              this.disabled
            }" multiple="multiple" tabindex="-1">${Wn(
              this.value,
              (e) => ft`<option selected="selected" value="${e}"></option>`
            )}</select>`
          : ft`<input ${Ni(
              this.hiddenInputRef
            )} type="radio" class="hidden-input" name="${Vt(
              this.name
            )}" value="${Vt(this.value)}" .required="${
              this.required
            }" .disabled="${this.disabled}" .checked="${e}" tabindex="-1">`
      ...
      }" .label="${this.label}" .placeholder="${this.placeholder}" .helper="${
        this.helper
      }" .error="${this.hiddenInputRef.value?.validationMessage}" .clearable="${
        this.clearable
      }" .clearIcon="${this.clearIcon}" .endAligned="${
        this.endAligned
      }" .prefix="${this.prefix}" .suffix="${this.suffix}" .icon="${
        this.icon
      }" .endIcon="${this.endIcon}" .errorIcon="${this.errorIcon}" .form="${
        this.form
      }" .disabled="${this.disabled}" .required="${
        this.required
      }" .invalidStyle="${this.invalid}" @clear="${this.onClear}" @change="${(
        e
      ) => e.stopPropagation()}" @keydown="${this.onTextFieldKeyDown}">${Wn(
        [
          "icon",
          "end-icon",
          "error-icon",
        ...
        () =>
          ft`<div slot="input" class="chips" part="chips">${Wn(
            this.value,
            (e) =>
              ft`<mdui-chip class="chip" part="chip" exportparts="${[
                ...
                this.onDeleteOneValue(e)}">${this.getMenuItemLabelByValue(
                e
              )}</mdui-chip>`
          )}</div>`
      )}</mdui-text-field><mdui-menu ${Ni(
        this.menuRef
      )} part="menu" .selects="${
    ...
    getMenuItemLabelByValue(e) {
      return (
        (this.menuItems.length &&
          this.menuItems.find((t) => t.value === e)?.textContent?.trim()) ||
        e
      );
    }
    resizeMenu() {
    ...
    async onValueChange(e) {
      ...
      i && Hi.get(i)?.has(this)
        ? ((this.invalid = !1), Hi.get(i).delete(this))
        : (this.invalid = !this.hiddenInputRef.value.checkValidity());
    }
    onDeleteOneValue(e) {
      const t = [...this.value];
    ...
    (e.Select.styles = [ei, or]),
    Se([zt({ reflect: !0 })], e.Select.prototype, "variant", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Select.prototype,
      "multiple",
    ...
    Se([zt({ reflect: !0 })], e.Select.prototype, "name", void 0),
    Se([zt()], e.Select.prototype, "value", void 0),
    Se([no()], e.Select.prototype, "defaultValue", void 0),
    Se([zt({ reflect: !0 })], e.Select.prototype, "label", void 0),
    Se([zt({ reflect: !0 })], e.Select.prototype, "placeholder", void 0),
    Se([zt({ reflect: !0 })], e.Select.prototype, "helper", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Select.prototype,
      "clearable",
    ...
    Se([zt({ reflect: !0 })], e.Select.prototype, "placement", void 0),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se([zt({ reflect: !0 })], e.Select.prototype, "prefix", void 0),
    Se([zt({ reflect: !0 })], e.Select.prototype, "suffix", void 0),
    Se([zt({ reflect: !0 })], e.Select.prototype, "icon", void 0),
    Se(
      [zt({ reflect: !0, attribute: "end-icon" })],
      e.Select.prototype,
      "endIcon",
    ...
    Se([zt({ reflect: !0 })], e.Select.prototype, "form", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Select.prototype,
      "readonly",
    ...
    Se([Nt()], e.Select.prototype, "invalid", void 0),
    Se(
      [Ft({ flatten: !0, selector: "mdui-menu-item" })],
      e.Select.prototype,
      "menuItems",
    ...
    (e.Select = Se([_t("mdui-select")], e.Select));
  const nr = Pe`.track-active{left:-.125rem;border-radius:var(--mdui-shape-corner-full) 0 0 var(--mdui-shape-corner-full)}`;
  (e.Slider = class extends Yn {
    constructor() {
      super(...arguments),
        (this.value = 0),
        (this.defaultValue = 0),
    ...
    render() {
      return ft`<label class="${Gi({ invalid: this.invalid })}"><input ${Ni(
        ...
        this.max
      }" ?disabled="${this.disabled}" .value="${oo(
        this.value.toString()
        ...
        this.handleRef
      )} part="handle" class="handle"><div class="elevation"></div><mdui-ripple ${Ni(
        this.rippleRef
      )} .noRipple="${this.noRipple}"></mdui-ripple>${this.renderLabel(
        this.value
      )}</div>${bo(this.tickmarks, () =>
  ...
  (e.Snackbar = class extends Jt {
    ...
    async onOpenChange() {
      ...
      if (this.open) {
        ...
        window.clearTimeout(this.closeTimeout),
          ...
          (this.style.display = "flex"),
          await Promise.all([wo(this), ...t.map((e) => wo(e))]),
          sr.push({ height: this.clientHeight, snackbar: this }),
      ...
      if (!this.open && this.hasUpdated) {
        ...
        window.clearTimeout(this.closeTimeout),
          await Promise.all([wo(this), ...t.map((e) => wo(e))]);
        const i = Ro(this, "short4");
        await Promise.all([
          yo(this, [{ opacity: 1 }, { opacity: 0 }], {
            duration: i,
            easing: e,
            fill: "forwards",
          }),
          ...
          (this.style.display = "none"),
          this.emit("closed");
        const o = sr.findIndex((e) => e.snackbar === this);
        return (
          sr.splice(o, 1),
          void (sr[o] && (await this.reorderStack(sr[o].snackbar)))
        );
      }
    }
    async onStackChange() {
    ...
    connectedCallback() {
      super.connectedCallback(),
        document.addEventListener("pointerdown", this.onDocumentClick),
        (this.mobile = Nn().down("sm")),
        (this.observeResize = Di(document.documentElement, async () => {
          const e = Nn().down("sm");
          this.mobile !== e &&
            ((this.mobile = e),
            ar || ((ar = !0), await this.reorderStack(), (ar = !1)));
        }));
    }
    disconnectedCallback() {
      super.disconnectedCallback(),
    ...
    async reorderStack(e) {
      for (
        let t = e ? sr.findIndex((t) => t.snackbar === e) : 0;
        t < sr.length;
        t++
      ) {
        const e = sr[t].snackbar;
        this.mobile
          ? ["top", "bottom"].forEach((i) => {
              if (e.placement.startsWith(i)) {
                const o = sr.filter(
                    (e, o) => o < t && e.snackbar.placement.startsWith(i)
                  ),
          ...
          : [
              ...
              if (e.placement === i) {
                const o = sr.filter(
                    (e, o) => o < t && e.snackbar.placement === i
                  ),
                  n = o.reduce((e, t) => e + t.height, 0);
                (e.style[
    ...
    Se([zt({ reflect: !0 })], e.Snackbar.prototype, "placement", void 0),
    Se(
      [zt({ reflect: !0, attribute: "action" })],
      e.Snackbar.prototype,
      "action",
      void 0
    ),
    ...
    Se(
      [zt({ reflect: !0, attribute: "close-icon" })],
      e.Snackbar.prototype,
      "closeIcon",
      void 0
    ),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "message-line" })],
      e.Snackbar.prototype,
      "messageLine",
      void 0
    ),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "auto-close-delay" })],
      e.Snackbar.prototype,
      "autoCloseDelay",
      void 0
    ),
    ...
    Se([xi("open")], e.Snackbar.prototype, "onOpenChange", null),
    Se(
      [xi("placement", !0), xi("messageLine", !0)],
      e.Snackbar.prototype,
      "onStackChange",
      null
    ),
    (e.Snackbar = Se([_t("mdui-snackbar")], e.Snackbar));
  ...
  (e.Switch = class extends Ji(Wi(Jt)) {
    constructor() {
      super(...arguments),
        (this.disabled = !1),
        (this.checked = !1),
        ...
        (this.hasSlotController = new Zt(this, "unchecked-icon"));
    }
    get validity() {
      return this.inputRef.value.validity;
    }
    ...
    render() {
      return ft`<label class="${Gi({
        invalid: this.invalid,
        "has-unchecked-icon":
          this.uncheckedIcon || this.hasSlotController.test("unchecked-icon"),
      })}"><input ${Ni(this.inputRef)} type="checkbox" name="${Vt(
        this.name
      )}" value="${Vt(this.value)}" .disabled="${this.disabled}" .checked="${oo(
        this.checked
      )}" .required="${this.required}" @change="${
        this.onChange
      }"><div part="track" class="track"><div part="thumb" class="thumb"><mdui-ripple ${Ni(
        this.rippleRef
      )} .noRipple="${
        this.noRipple
    ...
    Se([no("checked")], e.Switch.prototype, "defaultChecked", void 0),
    Se(
      [zt({ reflect: !0, attribute: "unchecked-icon" })],
      e.Switch.prototype,
      "uncheckedIcon",
  ...
  (e.Tab = class extends Ji(Wi(Jt)) {
    constructor() {
      super(...arguments),
        ...
        (this.key = Si()),
        (this.rippleRef = Bi()),
        (this.hasSlotController = new Zt(this, "icon", "custom"));
    }
    get rippleElement() {
      return this.rippleRef.value;
    }
    ...
    render() {
      ...
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${
        this.noRipple
      }"></mdui-ripple><div part="container" class="${Gi({
        container: !0,
        preset: !t,
        "variant-secondary": "secondary" === this.variant,
      })}"><slot name="custom"><div class="icon-container">${bo(
        e || this.icon,
        i
      )}<slot name="icon" part="icon" class="icon">${
        this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Qt
      }</slot></div><div class="label-container">${bo(
        !e,
        i
    ...
    (e.Tab.styles = [ei, cr]),
    Se([zt({ reflect: !0 })], e.Tab.prototype, "value", void 0),
    Se([zt({ reflect: !0 })], e.Tab.prototype, "icon", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Tab.prototype,
      "inline",
    ...
    Se([Nt()], e.Tab.prototype, "variant", void 0),
    (e.Tab = Se([_t("mdui-tab")], e.Tab));
  const dr = Pe`:host{display:block;overflow-y:auto;flex:1 1 auto}:host(:not([active])){display:none}`;
  (e.TabPanel = class extends Jt {
    constructor() {
    ...
    (e.TabPanel.styles = [ei, dr]),
    Se([zt({ reflect: !0 })], e.TabPanel.prototype, "value", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
  ...
  (e.Tabs = class extends Jt {
    ...
    connectedCallback() {
      super.connectedCallback(),
        this.updateComplete.then(() => {
          this.observeResize = Di(this.containerRef.value, () =>
    ...
    render() {
      return ft`<div ${Ni(
        this.containerRef
      )} part="container" class="container ${Gi({
        initial: this.isInitial,
      })}"><slot @slotchange="${this.onSlotChange}" @click="${
        this.onClick
      }"></slot><div ${Ni(
    ...
    async onClick(e) {
      ...
      t &&
        ((this.activeKey = t.key), (this.isInitial = !1), this.updateActive());
    }
    updateActive() {
    ...
    updateIndicator() {
      ...
      if ("primary" === this.variant) {
        const t = o.find(':scope > [slot="custom"]'),
          s = t.length
            ? t.get()
            : M(e.renderRoot).find('slot[name="custom"]').children().get();
        if (i) {
          const e = Math.min(...s.map((e) => e.offsetTop)) + n;
          a = {
            top: e,
            height:
              Math.max(...s.map((e) => e.offsetTop + e.offsetHeight)) + n - e,
          };
        } else {
          ...
          a = {
            left: e,
            width:
              Math.max(...s.map((e) => e.offsetLeft + e.offsetWidth)) + r - e,
          };
        }
      }
    ...
    (e.Tabs.styles = [ei, hr]),
    Se([zt({ reflect: !0 })], e.Tabs.prototype, "variant", void 0),
    Se([zt({ reflect: !0 })], e.Tabs.prototype, "value", void 0),
    Se([zt({ reflect: !0 })], e.Tabs.prototype, "placement", void 0),
    Se(
      [
        zt({
          type: Boolean,
    ...
    Se([Nt()], e.Tabs.prototype, "activeKey", void 0),
    Se([Nt()], e.Tabs.prototype, "isInitial", void 0),
    Se(
      [Ft({ selector: "mdui-tab", flatten: !0 })],
      e.Tabs.prototype,
      "tabs",
      void 0
    ),
    Se(
      [Ft({ selector: "mdui-tab-panel", slot: "panel", flatten: !0 })],
      e.Tabs.prototype,
      "panels",
      void 0
    ),
    Se([xi("activeKey", !0)], e.Tabs.prototype, "onActiveKeyChange", null),
    Se([xi("value")], e.Tabs.prototype, "onValueChange", null),
    Se(
      [xi("variant", !0), xi("placement", !0), xi("fullWidth", !0)],
      e.Tabs.prototype,
      "onIndicatorChange",
      null
    ),
    (e.Tabs = Se([_t("mdui-tabs")], e.Tabs));
  class ur {
    constructor(e, t) {
      (this.isHover = !1),
        (this.uniqueID = Si()),
  ...
  (e.Tooltip = class extends Jt {
    constructor() {
      super(),
        ...
        (this.open = !1),
        (this.popupRef = Bi()),
        (this.hasSlotController = new Zt(this, "headline", "action")),
        (this.hoverController = new ur(this, this.popupRef)),
        (this.definedController = new Ci(this, { needDomReady: !0 })),
        (this.onDocumentClick = this.onDocumentClick.bind(this)),
        (this.onWindowScroll = this.onWindowScroll.bind(this)),
        (this.onFocus = this.onFocus.bind(this)),
    ...
    connectedCallback() {
      super.connectedCallback(),
        document.addEventListener("pointerdown", this.onDocumentClick),
        this.definedController.whenDefined().then(() => {
          (this.overflowAncestors = xn(this.target)),
            this.overflowAncestors.forEach((e) => {
              e.addEventListener("scroll", this.onWindowScroll);
            }),
            (this.observeResize = Di(this.target, () => {
              this.updatePositioner();
            }));
        });
    }
    ...
    render() {
      ...
      return ft`<slot></slot><div ${Ni(
        this.popupRef
      )} part="popup" class="popup" hidden>${bo(
        e,
        () =>
    ...
    (e.Tooltip.styles = [ei, pr]),
    Se([zt({ reflect: !0 })], e.Tooltip.prototype, "variant", void 0),
    Se([zt({ reflect: !0 })], e.Tooltip.prototype, "placement", void 0),
    Se(
      [zt({ type: Number, reflect: !0, attribute: "open-delay" })],
      e.Tooltip.prototype,
      "openDelay",
    ...
    Se([zt({ reflect: !0 })], e.Tooltip.prototype, "headline", void 0),
    Se([zt({ reflect: !0 })], e.Tooltip.prototype, "content", void 0),
    Se([zt({ reflect: !0 })], e.Tooltip.prototype, "trigger", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
      e.Tooltip.prototype,
      "disabled",
  ...
  (e.TopAppBarTitle = class extends Jt {
    ...
    render() {
      ...
      return ft`<slot part="label" class="label ${t}" ${Ni(
        this.defaultSlotRef
  ...
  (e.TopAppBar = class extends Ri(Li) {
    constructor() {
      super(...arguments),
        (this.variant = "small"),
        (this.hide = !1),
    ...
    (e.TopAppBar.styles = [ei, fr]),
    Se([zt({ reflect: !0 })], e.TopAppBar.prototype, "variant", void 0),
    Se(
      [zt({ type: Boolean, reflect: !0, converter: ki })],
    ...
    Se(
      [Ft({ selector: "mdui-top-app-bar-title", flatten: !0 })],
      e.TopAppBar.prototype,
      "titleElements",
      void 0
    ),
    Se([xi("variant")], e.TopAppBar.prototype, "onVariantChange", null),
    Se([xi("shrink")], e.TopAppBar.prototype, "onShrinkChange", null),
    (e.TopAppBar = Se([_t("mdui-top-app-bar")], e.TopAppBar));
  const gr = {};
  function br(e, t) {
    if ((u(gr[e]) && (gr[e] = []), u(t))) return gr[e];
    gr[e].push(t);
  }
  function yr(e) {
    if (u(gr[e])) return;
    if (!gr[e].length) return;
    gr[e].shift()();
  }
  const wr = { onClick: x },
    kr = "mdui.functions.dialog.";
  let Cr;
  const xr = (t) => {
      ...
      return (
        ...
        o.appendTo("body").on("closed", (e) => {
          e.target === i &&
            (o.remove(), t.queue && ((Cr = void 0), yr(kr + t.queue)));
        }),
        t.queue
          ? Cr
            ? br(kr + t.queue, () => {
    ...
    $r = () => _o("OK", { id: "functions.alert.confirmText" }),
    Rr = () => _o("OK", { id: "functions.confirm.confirmText" }),
    Ir = () => _o("Cancel", { id: "functions.confirm.cancelText" });
  function Sr(e) {
  ...
  const Lr = [
    ...
    Br = [95.047, 100, 108.883];
  function Or(e, t, i) {
    return (
      ((255 << 24) | ((255 & e) << 16) | ((255 & t) << 8) | (255 & i)) >>> 0
    );
  }
  function zr(e) {
    return Or(Wr(e[0]), Wr(e[1]), Wr(e[2]));
  }
  function Nr(e) {
    return (e >> 16) & 255;
  }
  ...
  function Hr(e, t, i) {
    ...
    return Or(Wr(n), Wr(r), Wr(s));
  }
  function Ur(e) {
    const t = (function (e) {
      return Pr([jr(Nr(e)), jr(Fr(e)), jr(Vr(e))], Lr);
    })(e)[1];
    return 116 * Gr(t / 100) - 16;
  }
  function Kr(e) {
    return 100 * Yr((e + 16) / 116);
  }
  function qr(e) {
    return 116 * Gr(e / 100) - 16;
  }
  function jr(e) {
    const t = e / 255;
  ...
  class Xr {
    static make(
      ...
      const r = e,
        ...
        d =
          c >= 0.9
            ? Er(0.59, 0.69, 10 * (c - 0.9))
            : Er(0.525, 0.59, 10 * (c - 0.8));
  ...
  class Jr {
    ...
    static fromInt(e) {
      return Jr.fromIntInViewingConditions(e, Xr.DEFAULT);
    }
    static fromIntInViewingConditions(e, t) {
      const i = (65280 & e) >> 8,
        ...
        y = (400 * Sr(p) * v) / (v + 27.13),
        w = (400 * Sr(m) * g) / (g + 27.13),
        k = (400 * Sr(f) * b) / (b + 27.13),
        C = (11 * y + -12 * w + k) / 11,
        x = (y + w - 2 * k) / 9,
        $ = (20 * y + 20 * w + 21 * k) / 20,
        R = (40 * y + 20 * w + k) / 20,
        ...
        F = N * Math.cos(E),
        V = N * Math.sin(E);
      return new Jr(S, _, D, A, B, O, z, F, V);
    }
    static fromJch(e, t, i) {
      return Jr.fromJchInViewingConditions(e, t, i, Xr.DEFAULT);
    }
    static fromJchInViewingConditions(e, t, i, o) {
      const n = (4 / o.c) * Math.sqrt(e / 100) * (o.aw + 4) * o.fLRoot,
        ...
        h = d * Math.cos(l),
        u = d * Math.sin(l);
      return new Jr(i, t, e, n, r, a, c, h, u);
    }
    static fromUcs(e, t, i) {
      return Jr.fromUcsInViewingConditions(e, t, i, Xr.DEFAULT);
    }
    static fromUcsInViewingConditions(e, t, i, o) {
      ...
      return Jr.fromJchInViewingConditions(c, a, l, o);
    }
    toInt() {
    ...
    viewed(e) {
      const t =
        ...
        g = Sr(p) * (100 / e.fl) * Math.pow(v, 1 / 0.42),
        b = Math.max(0, (27.13 * Math.abs(m)) / (400 - Math.abs(m))),
        y = Sr(m) * (100 / e.fl) * Math.pow(b, 1 / 0.42),
        w = Math.max(0, (27.13 * Math.abs(f)) / (400 - Math.abs(f))),
        k = Sr(f) * (100 / e.fl) * Math.pow(w, 1 / 0.42),
        C = g / e.rgbD[0],
        x = y / e.rgbD[1],
        $ = k / e.rgbD[2];
      return Hr(
    ...
    static fromXyzInViewingConditions(e, t, i, o) {
      const n = 0.401288 * e + 0.650173 * t - 0.051461 * i,
        ...
        p = (400 * Sr(a) * d) / (d + 27.13),
        m = (400 * Sr(l) * h) / (h + 27.13),
        f = (400 * Sr(c) * u) / (u + 27.13),
        v = (11 * p + -12 * m + f) / 11,
        g = (p + m - 2 * f) / 9,
        b = (20 * p + 20 * m + 21 * f) / 20,
        y = (40 * p + 20 * m + f) / 20,
  ...
  class Zr {
    ...
    static chromaticAdaptation(e) {
      ...
      return (400 * Sr(e) * t) / (t + 27.13);
    }
    static hueOf(e) {
      const t = Pr(e, Zr.SCALED_DISCOUNT_FROM_LINRGB),
        i = Zr.chromaticAdaptation(t[0]),
        o = Zr.chromaticAdaptation(t[1]),
        n = Zr.chromaticAdaptation(t[2]),
        r = (11 * i + -12 * o + n) / 11,
        s = (i + o - 2 * n) / 9;
      return Math.atan2(s, r);
    }
    static areInCyclicOrder(e, t, i) {
      return Zr.sanitizeRadians(t - e) < Zr.sanitizeRadians(i - e);
    }
    ...
    static setCoordinate(e, t, i, o) {
      const n = Zr.intercept(e[o], t, i[o]);
      return Zr.lerpPoint(e, n, i);
    }
    static isBounded(e) {
      return 0 <= e && e <= 100;
    }
    static nthVertex(e, t) {
      const i = Zr.Y_FROM_LINRGB[0],
        o = Zr.Y_FROM_LINRGB[1],
        n = Zr.Y_FROM_LINRGB[2],
        r = t % 4 <= 1 ? 0 : 100,
        s = t % 2 == 0 ? 0 : 100;
      if (t < 4) {
        const t = r,
          a = s,
          l = (e - t * o - a * n) / i;
        return Zr.isBounded(l) ? [l, t, a] : [-1, -1, -1];
      }
      if (t < 8) {
        const t = r,
          a = s,
          l = (e - a * i - t * n) / o;
        return Zr.isBounded(l) ? [a, l, t] : [-1, -1, -1];
      }
      {
        const t = r,
          a = s,
          l = (e - t * i - a * o) / n;
        return Zr.isBounded(l) ? [t, a, l] : [-1, -1, -1];
      }
    }
    static bisectToSegment(e, t) {
      let i = [-1, -1, -1],
        ...
        a = !0;
      for (let l = 0; l < 12; l++) {
        const c = Zr.nthVertex(e, l);
        if (c[0] < 0) continue;
        const d = Zr.hueOf(c);
        s
          ? (a || Zr.areInCyclicOrder(n, d, r)) &&
            ((a = !1),
            Zr.areInCyclicOrder(n, t, d)
              ? ((o = c), (r = d))
              : ((i = c), (n = d)))
          : ((i = c), (o = c), (n = d), (r = d), (s = !0));
      }
    ...
    static bisectToLimit(e, t) {
      const i = Zr.bisectToSegment(e, t);
      let o = i[0],
        n = Zr.hueOf(o),
        r = i[1];
      for (let e = 0; e < 3; e++)
        if (o[e] !== r[e]) {
          let i = -1,
            s = 255;
          o[e] < r[e]
            ? ((i = Zr.criticalPlaneBelow(Zr.trueDelinearized(o[e]))),
              (s = Zr.criticalPlaneAbove(Zr.trueDelinearized(r[e]))))
            : ((i = Zr.criticalPlaneAbove(Zr.trueDelinearized(o[e]))),
              (s = Zr.criticalPlaneBelow(Zr.trueDelinearized(r[e]))));
          for (let a = 0; a < 8 && !(Math.abs(s - i) <= 1); a++) {
            const a = Math.floor((i + s) / 2),
              l = Zr.CRITICAL_PLANES[a],
              c = Zr.setCoordinate(o, l, r, e),
              d = Zr.hueOf(c);
            Zr.areInCyclicOrder(n, t, d)
              ? ((r = c), (s = a))
              : ((o = c), (n = d), (i = a));
    ...
    static findResultByJ(e, t, i) {
      ...
      for (let e = 0; e < 5; e++) {
        const c = o / 100,
          ...
          y = Pr(
            [
              Zr.inverseChromaticAdaptation(v),
              Zr.inverseChromaticAdaptation(g),
              Zr.inverseChromaticAdaptation(b),
            ],
            Zr.LINRGB_FROM_SCALED_DISCOUNT
          );
        if (y[0] < 0 || y[1] < 0 || y[2] < 0) return 0;
        const w = Zr.Y_FROM_LINRGB[0],
          k = Zr.Y_FROM_LINRGB[1],
          C = Zr.Y_FROM_LINRGB[2],
          x = w * y[0] + k * y[1] + C * y[2];
        if (x <= 0) return 0;
        if (4 === e || Math.abs(x - i) < 0.002)
          return y[0] > 100.01 || y[1] > 100.01 || y[2] > 100.01 ? 0 : zr(y);
        o -= ((x - i) * o) / (2 * x);
      }
      return 0;
    }
    static solveToInt(e, t, i) {
      ...
      const o = ((e = Ar(e)) / 180) * Math.PI,
        n = Kr(i),
        r = Zr.findResultByJ(o, t, n);
      if (0 !== r) return r;
      return zr(Zr.bisectToLimit(n, o));
    }
    static solveToCam(e, t, i) {
      return Jr.fromInt(Zr.solveToInt(e, t, i));
    }
  }
  (Zr.SCALED_DISCOUNT_FROM_LINRGB = [
    ...
    (Zr.Y_FROM_LINRGB = [0.2126, 0.7152, 0.0722]),
    (Zr.CRITICAL_PLANES = [
      ...
      73.41800625771542, 74.16517879925733, 74.9167682708136, 75.67278210128072,
      76.43322770089146, 77.1981124613393, 77.96744375590167, 78.74122893956174,
      79.51947534912904, 80.30219030335869, 81.08938110306934,
      ...
      90.88742016217518, 91.73345337380438, 92.58406282226491,
      93.43925555268066, 94.29903859396902, 95.16341895893969,
      96.03240364439274, 96.9059996312159, 97.78421388448044, 98.6670533535366,
      99.55452497210776,
    ]);
  class Qr {
    static from(e, t, i) {
      return new Qr(Zr.solveToInt(e, t, i));
    }
    static fromInt(e) {
      return new Qr(e);
    }
    ...
    set tone(e) {
      this.setInternalState(
        Zr.solveToInt(this.internalHue, this.internalChroma, e)
      );
    }
    constructor(e) {
      this.argb = e;
    ...
    inViewingConditions(e) {
      const t = Jr.fromInt(this.toInt()).xyzInViewingConditions(e),
        i = Jr.fromXyzInViewingConditions(t[0], t[1], t[2], Xr.make());
      return Qr.from(i.hue, i.chroma, qr(t[1]));
    }
  }
  class es {
    static harmonize(e, t) {
      const i = Qr.fromInt(e),
        o = Qr.fromInt(t),
        n = Mr(i.hue, o.hue),
        r = Math.min(0.5 * n, 15),
        s = Ar(i.hue + r * ((a = i.hue), Ar(o.hue - a) <= 180 ? 1 : -1));
      var a;
      return Qr.from(s, i.chroma, i.tone).toInt();
    }
    static hctHue(e, t, i) {
      const o = es.cam16Ucs(e, t, i),
        n = Jr.fromInt(o),
        r = Jr.fromInt(e);
      return Qr.from(n.hue, r.chroma, Ur(e)).toInt();
    }
    static cam16Ucs(e, t, i) {
      const o = Jr.fromInt(e),
        n = Jr.fromInt(t),
        r = o.jstar,
        s = o.astar,
        a = o.bstar,
        ...
        c = s + (n.astar - s) * i,
        d = a + (n.bstar - a) * i;
      return Jr.fromUcs(l, c, d).toInt();
    }
  }
  class ts {
    static ratioOfTones(e, t) {
      return (
        (e = Tr(0, 100, e)), (t = Tr(0, 100, t)), ts.ratioOfYs(Kr(e), Kr(t))
      );
    }
    ...
    static lighterUnsafe(e, t) {
      const i = ts.lighter(e, t);
      return i < 0 ? 100 : i;
    }
    static darkerUnsafe(e, t) {
      const i = ts.darker(e, t);
      return i < 0 ? 0 : i;
    }
  }
  class is {
    ...
    static fixIfDisliked(e) {
      return is.isDisliked(e) ? Qr.from(e.hue, e.chroma, 70) : e;
    }
  }
  class os {
    ...
    getTone(e) {
      ...
      if (this.toneDeltaPair) {
        const i = this.toneDeltaPair(e),
          ...
          v = d.tone(e);
        let g = ts.ratioOfTones(l, v) >= m ? v : os.foregroundTone(l, m);
        const b = h.tone(e);
        let y = ts.ratioOfTones(l, b) >= f ? b : os.foregroundTone(l, f);
        return (
          t && ((g = os.foregroundTone(l, m)), (y = os.foregroundTone(l, f))),
          (y - g) * p >= r ||
            ((y = Tr(0, 100, g + r * p)),
            (y - g) * p >= r || (g = Tr(0, 100, y - r * p))),
          50 <= g && g < 60
            ? p > 0
      ...
      }
      {
        ...
        if (
          (ts.ratioOfTones(o, i) >= n || (i = os.foregroundTone(o, n)),
          t && (i = os.foregroundTone(o, n)),
          this.isBackground &&
            50 <= i &&
            i < 60 &&
            (i = ts.ratioOfTones(49, o) >= n ? 49 : 60),
          ...
          if (ts.ratioOfTones(a, i) >= n && ts.ratioOfTones(l, i) >= n)
            return i;
          const c = ts.lighter(a, n),
            d = ts.darker(l, n),
            h = [];
          -1 !== c && h.push(c), -1 !== d && h.push(d);
          return os.tonePrefersLightForeground(r) ||
            os.tonePrefersLightForeground(s)
            ? c < 0
              ? 100
              : c
            : 1 === h.length
    ...
    static foregroundTone(e, t) {
      const i = ts.lighterUnsafe(e, t),
        o = ts.darkerUnsafe(e, t),
        n = ts.ratioOfTones(i, e),
        r = ts.ratioOfTones(o, e);
      if (os.tonePrefersLightForeground(e)) {
    ...
    static enableLightForeground(e) {
      return os.tonePrefersLightForeground(e) &&
        !os.toneAllowsLightForeground(e)
        ? 49
        : e;
    }
  }
  class ns {
    static fromInt(e) {
      const t = Qr.fromInt(e);
      return ns.fromHct(t);
    }
    static fromHct(e) {
      return new ns(e.hue, e.chroma, e);
    }
    static fromHueAndChroma(e, t) {
      const i = new rs(e, t).create();
      return new ns(e, t, i);
    }
    constructor(e, t, i) {
      (this.hue = e),
    ...
    tone(e) {
      ...
      return (
        void 0 === t &&
          ((t = Qr.from(this.hue, this.chroma, e).toInt()),
          this.cache.set(e, t)),
        t
      );
    }
    getHct(e) {
      return Qr.fromInt(this.tone(e));
    }
  }
  class rs {
    constructor(e, t) {
      ...
      for (; e < t; ) {
        ...
        if (this.maxChroma(i) >= this.requestedChroma - 0.01)
          if (Math.abs(e - 50) < Math.abs(t - 50)) t = i;
            ...
            if (e === i) return Qr.from(this.hue, this.requestedChroma, e);
            e = i;
          }
        else o ? (e = i + 1) : (t = i);
      }
      return Qr.from(this.hue, this.requestedChroma, e);
    }
    maxChroma(e) {
      if (this.chromaCache.has(e)) return this.chromaCache.get(e);
      const t = Qr.from(this.hue, this.maxChromaValue, e).chroma;
  ...
  class ss {
    ...
    get(e) {
      return e <= -1
        ? this.low
        : e < 0
        ? Er(this.low, this.normal, (e - -1) / 1)
        : e < 0.5
        ? Er(this.normal, this.medium, (e - 0) / 0.5)
        : e < 1
        ? Er(this.medium, this.high, (e - 0.5) / 0.5)
        : this.high;
    }
  }
  class as {
  ...
  var ls;
  function cs(e) {
    return e.variant === ls.FIDELITY || e.variant === ls.CONTENT;
  }
  function ds(e) {
    return e.variant === ls.MONOCHROME;
  }
  !(function (e) {
  ...
  class hs {
    static highestSurface(e) {
      return e.isDark ? hs.surfaceBright : hs.surfaceDim;
    }
  }
  (hs.contentAccentToneDelta = 15),
    (hs.primaryPaletteKeyColor = os.fromPalette({
      name: "primary_palette_key_color",
      palette: (e) => e.primaryPalette,
      tone: (e) => e.primaryPalette.keyColor.tone,
    })),
    (hs.secondaryPaletteKeyColor = os.fromPalette({
      name: "secondary_palette_key_color",
      palette: (e) => e.secondaryPalette,
      tone: (e) => e.secondaryPalette.keyColor.tone,
    })),
    (hs.tertiaryPaletteKeyColor = os.fromPalette({
      name: "tertiary_palette_key_color",
      palette: (e) => e.tertiaryPalette,
      tone: (e) => e.tertiaryPalette.keyColor.tone,
    })),
    (hs.neutralPaletteKeyColor = os.fromPalette({
      name: "neutral_palette_key_color",
      palette: (e) => e.neutralPalette,
      tone: (e) => e.neutralPalette.keyColor.tone,
    })),
    (hs.neutralVariantPaletteKeyColor = os.fromPalette({
      name: "neutral_variant_palette_key_color",
      palette: (e) => e.neutralVariantPalette,
      tone: (e) => e.neutralVariantPalette.keyColor.tone,
    })),
    (hs.background = os.fromPalette({
      name: "background",
      palette: (e) => e.neutralPalette,
      tone: (e) => (e.isDark ? 6 : 98),
      isBackground: !0,
    })),
    (hs.onBackground = os.fromPalette({
      name: "on_background",
      palette: (e) => e.neutralPalette,
      tone: (e) => (e.isDark ? 90 : 10),
      background: (e) => hs.background,
      contrastCurve: new ss(3, 3, 4.5, 7),
    })),
    (hs.surface = os.fromPalette({
      name: "surface",
      palette: (e) => e.neutralPalette,
      tone: (e) => (e.isDark ? 6 : 98),
      isBackground: !0,
    })),
    (hs.surfaceDim = os.fromPalette({
      name: "surface_dim",
      palette: (e) => e.neutralPalette,
      tone: (e) => (e.isDark ? 6 : new ss(87, 87, 80, 75).get(e.contrastLevel)),
      isBackground: !0,
    })),
    (hs.surfaceBright = os.fromPalette({
      name: "surface_bright",
      palette: (e) => e.neutralPalette,
      tone: (e) =>
        e.isDark ? new ss(24, 24, 29, 34).get(e.contrastLevel) : 98,
      isBackground: !0,
    })),
    (hs.surfaceContainerLowest = os.fromPalette({
      name: "surface_container_lowest",
      palette: (e) => e.neutralPalette,
      tone: (e) => (e.isDark ? new ss(4, 4, 2, 0).get(e.contrastLevel) : 100),
      isBackground: !0,
    })),
    (hs.surfaceContainerLow = os.fromPalette({
      name: "surface_container_low",
      palette: (e) => e.neutralPalette,
      tone: (e) =>
        e.isDark
          ? new ss(10, 10, 11, 12).get(e.contrastLevel)
          : new ss(96, 96, 96, 95).get(e.contrastLevel),
      isBackground: !0,
    })),
    (hs.surfaceContainer = os.fromPalette({
      name: "surface_container",
      palette: (e) => e.neutralPalette,
      tone: (e) =>
        e.isDark
          ? new ss(12, 12, 16, 20).get(e.contrastLevel)
          : new ss(94, 94, 92, 90).get(e.contrastLevel),
      isBackground: !0,
    })),
    (hs.surfaceContainerHigh = os.fromPalette({
      name: "surface_container_high",
      palette: (e) => e.neutralPalette,
      tone: (e) =>
        e.isDark
          ? new ss(17, 17, 21, 25).get(e.contrastLevel)
          : new ss(92, 92, 88, 85).get(e.contrastLevel),
      isBackground: !0,
    })),
    (hs.surfaceContainerHighest = os.fromPalette({
      name: "surface_container_highest",
      palette: (e) => e.neutralPalette,
      tone: (e) =>
        e.isDark
          ? new ss(22, 22, 26, 30).get(e.contrastLevel)
          : new ss(90, 90, 84, 80).get(e.contrastLevel),
      isBackground: !0,
    })),
    (hs.onSurface = os.fromPalette({
      name: "on_surface",
      palette: (e) => e.neutralPalette,
      tone: (e) => (e.isDark ? 90 : 10),
      background: (e) => hs.highestSurface(e),
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.surfaceVariant = os.fromPalette({
      name: "surface_variant",
      palette: (e) => e.neutralVariantPalette,
      tone: (e) => (e.isDark ? 30 : 90),
      isBackground: !0,
    })),
    (hs.onSurfaceVariant = os.fromPalette({
      name: "on_surface_variant",
      palette: (e) => e.neutralVariantPalette,
      tone: (e) => (e.isDark ? 80 : 30),
      background: (e) => hs.highestSurface(e),
      contrastCurve: new ss(3, 4.5, 7, 11),
    })),
    (hs.inverseSurface = os.fromPalette({
      name: "inverse_surface",
      palette: (e) => e.neutralPalette,
      tone: (e) => (e.isDark ? 90 : 20),
    })),
    (hs.inverseOnSurface = os.fromPalette({
      name: "inverse_on_surface",
      palette: (e) => e.neutralPalette,
      tone: (e) => (e.isDark ? 20 : 95),
      background: (e) => hs.inverseSurface,
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.outline = os.fromPalette({
      name: "outline",
      palette: (e) => e.neutralVariantPalette,
      tone: (e) => (e.isDark ? 60 : 50),
      background: (e) => hs.highestSurface(e),
      contrastCurve: new ss(1.5, 3, 4.5, 7),
    })),
    (hs.outlineVariant = os.fromPalette({
      name: "outline_variant",
      palette: (e) => e.neutralVariantPalette,
      tone: (e) => (e.isDark ? 30 : 80),
      background: (e) => hs.highestSurface(e),
      contrastCurve: new ss(1, 1, 3, 4.5),
    })),
    (hs.shadow = os.fromPalette({
      name: "shadow",
      palette: (e) => e.neutralPalette,
      tone: (e) => 0,
    })),
    (hs.scrim = os.fromPalette({
      name: "scrim",
      palette: (e) => e.neutralPalette,
      tone: (e) => 0,
    })),
    (hs.surfaceTint = os.fromPalette({
      name: "surface_tint",
      palette: (e) => e.primaryPalette,
      tone: (e) => (e.isDark ? 80 : 40),
      isBackground: !0,
    })),
    (hs.primary = os.fromPalette({
      name: "primary",
      palette: (e) => e.primaryPalette,
      tone: (e) => (ds(e) ? (e.isDark ? 100 : 0) : e.isDark ? 80 : 40),
      isBackground: !0,
      background: (e) => hs.highestSurface(e),
      contrastCurve: new ss(3, 4.5, 7, 7),
      toneDeltaPair: (e) =>
        new as(hs.primaryContainer, hs.primary, 10, "nearer", !1),
    })),
    (hs.onPrimary = os.fromPalette({
      name: "on_primary",
      palette: (e) => e.primaryPalette,
      tone: (e) => (ds(e) ? (e.isDark ? 10 : 90) : e.isDark ? 20 : 100),
      background: (e) => hs.primary,
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.primaryContainer = os.fromPalette({
    ...
    (hs.onPrimaryContainer = os.fromPalette({
      name: "on_primary_container",
      palette: (e) => e.primaryPalette,
      tone: (e) =>
        cs(e)
          ? os.foregroundTone(hs.primaryContainer.tone(e), 4.5)
          : ds(e)
          ? e.isDark
            ? 0
            : 100
          ...
          ? 90
          : 30,
      background: (e) => hs.primaryContainer,
      contrastCurve: new ss(3, 4.5, 7, 11),
    })),
    (hs.inversePrimary = os.fromPalette({
    ...
    (hs.secondary = os.fromPalette({
      ...
      contrastCurve: new ss(3, 4.5, 7, 7),
      toneDeltaPair: (e) =>
        new as(hs.secondaryContainer, hs.secondary, 10, "nearer", !1),
    })),
    (hs.onSecondary = os.fromPalette({
      name: "on_secondary",
      palette: (e) => e.secondaryPalette,
      tone: (e) => (ds(e) ? (e.isDark ? 10 : 100) : e.isDark ? 20 : 100),
      background: (e) => hs.secondary,
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.secondaryContainer = os.fromPalette({
    ...
    (hs.onSecondaryContainer = os.fromPalette({
      ...
      tone: (e) =>
        ds(e)
          ? e.isDark
            ...
            : 10
          : cs(e)
          ? os.foregroundTone(hs.secondaryContainer.tone(e), 4.5)
          : e.isDark
          ? 90
          : 30,
      background: (e) => hs.secondaryContainer,
      contrastCurve: new ss(3, 4.5, 7, 11),
    })),
    (hs.tertiary = os.fromPalette({
      name: "tertiary",
      palette: (e) => e.tertiaryPalette,
      tone: (e) => (ds(e) ? (e.isDark ? 90 : 25) : e.isDark ? 80 : 40),
      isBackground: !0,
      background: (e) => hs.highestSurface(e),
      contrastCurve: new ss(3, 4.5, 7, 7),
      toneDeltaPair: (e) =>
        new as(hs.tertiaryContainer, hs.tertiary, 10, "nearer", !1),
    })),
    (hs.onTertiary = os.fromPalette({
      name: "on_tertiary",
      palette: (e) => e.tertiaryPalette,
      tone: (e) => (ds(e) ? (e.isDark ? 10 : 90) : e.isDark ? 20 : 100),
      background: (e) => hs.tertiary,
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.tertiaryContainer = os.fromPalette({
      name: "tertiary_container",
      palette: (e) => e.tertiaryPalette,
      tone: (e) => {
        if (ds(e)) return e.isDark ? 60 : 49;
        if (!cs(e)) return e.isDark ? 30 : 90;
        const t = e.tertiaryPalette.getHct(e.sourceColorHct.tone);
        return is.fixIfDisliked(t).tone;
      },
      isBackground: !0,
      background: (e) => hs.highestSurface(e),
      contrastCurve: new ss(1, 1, 3, 4.5),
    ...
    (hs.onTertiaryContainer = os.fromPalette({
      ...
      tone: (e) =>
        ds(e)
          ? e.isDark
            ...
            : 100
          : cs(e)
          ? os.foregroundTone(hs.tertiaryContainer.tone(e), 4.5)
          : e.isDark
          ? 90
          : 30,
      background: (e) => hs.tertiaryContainer,
      contrastCurve: new ss(3, 4.5, 7, 11),
    })),
    (hs.error = os.fromPalette({
      name: "error",
      ...
      contrastCurve: new ss(3, 4.5, 7, 7),
      toneDeltaPair: (e) =>
        new as(hs.errorContainer, hs.error, 10, "nearer", !1),
    })),
    (hs.onError = os.fromPalette({
      name: "on_error",
      palette: (e) => e.errorPalette,
      tone: (e) => (e.isDark ? 20 : 100),
      background: (e) => hs.error,
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.errorContainer = os.fromPalette({
    ...
    (hs.onErrorContainer = os.fromPalette({
      name: "on_error_container",
      palette: (e) => e.errorPalette,
      tone: (e) => (ds(e) ? (e.isDark ? 90 : 10) : e.isDark ? 90 : 30),
      background: (e) => hs.errorContainer,
      contrastCurve: new ss(3, 4.5, 7, 11),
    })),
    (hs.primaryFixed = os.fromPalette({
      name: "primary_fixed",
      palette: (e) => e.primaryPalette,
      tone: (e) => (ds(e) ? 40 : 90),
      isBackground: !0,
      ...
      contrastCurve: new ss(1, 1, 3, 4.5),
      toneDeltaPair: (e) =>
        new as(hs.primaryFixed, hs.primaryFixedDim, 10, "lighter", !0),
    })),
    (hs.primaryFixedDim = os.fromPalette({
    ...
    (hs.onPrimaryFixed = os.fromPalette({
      name: "on_primary_fixed",
      palette: (e) => e.primaryPalette,
      tone: (e) => (ds(e) ? 100 : 10),
      background: (e) => hs.primaryFixedDim,
      secondBackground: (e) => hs.primaryFixed,
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.onPrimaryFixedVariant = os.fromPalette({
    ...
    (hs.secondaryFixed = os.fromPalette({
      ...
      contrastCurve: new ss(1, 1, 3, 4.5),
      toneDeltaPair: (e) =>
        new as(hs.secondaryFixed, hs.secondaryFixedDim, 10, "lighter", !0),
    })),
    (hs.secondaryFixedDim = os.fromPalette({
    ...
    (hs.onSecondaryFixed = os.fromPalette({
      name: "on_secondary_fixed",
      palette: (e) => e.secondaryPalette,
      tone: (e) => 10,
      background: (e) => hs.secondaryFixedDim,
      secondBackground: (e) => hs.secondaryFixed,
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.onSecondaryFixedVariant = os.fromPalette({
    ...
    (hs.tertiaryFixed = os.fromPalette({
      name: "tertiary_fixed",
      palette: (e) => e.tertiaryPalette,
      tone: (e) => (ds(e) ? 40 : 90),
      isBackground: !0,
      ...
      contrastCurve: new ss(1, 1, 3, 4.5),
      toneDeltaPair: (e) =>
        new as(hs.tertiaryFixed, hs.tertiaryFixedDim, 10, "lighter", !0),
    })),
    (hs.tertiaryFixedDim = os.fromPalette({
    ...
    (hs.onTertiaryFixed = os.fromPalette({
      name: "on_tertiary_fixed",
      palette: (e) => e.tertiaryPalette,
      tone: (e) => (ds(e) ? 100 : 10),
      background: (e) => hs.tertiaryFixedDim,
      secondBackground: (e) => hs.tertiaryFixed,
      contrastCurve: new ss(4.5, 7, 11, 21),
    })),
    (hs.onTertiaryFixedVariant = os.fromPalette({
  ...
  class us {
    ...
    static fromColors(e) {
      return us.createPaletteFromColors(!1, e);
    }
    static contentFromColors(e) {
      return us.createPaletteFromColors(!0, e);
    }
    static createPaletteFromColors(e, t) {
      const i = new us(t.primary, e);
      if (t.secondary) {
        const o = new us(t.secondary, e);
        i.a2 = o.a1;
      }
      if (t.tertiary) {
        const o = new us(t.tertiary, e);
        i.a3 = o.a1;
      }
      if (t.error) {
        const o = new us(t.error, e);
        i.error = o.a1;
      }
      if (t.neutral) {
        const o = new us(t.neutral, e);
        i.n1 = o.n1;
      }
      if (t.neutralVariant) {
        const o = new us(t.neutralVariant, e);
        i.n2 = o.n2;
      }
      return i;
    }
    constructor(e, t) {
      const i = Qr.fromInt(e),
        ...
        n = i.chroma;
      t
        ? ((this.a1 = ns.fromHueAndChroma(o, n)),
          (this.a2 = ns.fromHueAndChroma(o, n / 3)),
          (this.a3 = ns.fromHueAndChroma(o + 60, n / 2)),
          (this.n1 = ns.fromHueAndChroma(o, Math.min(n / 12, 4))),
          (this.n2 = ns.fromHueAndChroma(o, Math.min(n / 6, 8))))
        : ((this.a1 = ns.fromHueAndChroma(o, Math.max(48, n))),
          (this.a2 = ns.fromHueAndChroma(o, 16)),
          (this.a3 = ns.fromHueAndChroma(o + 60, 24)),
          (this.n1 = ns.fromHueAndChroma(o, 4)),
          (this.n2 = ns.fromHueAndChroma(o, 8))),
        (this.error = ns.fromHueAndChroma(25, 84));
    }
  }
  class ps {
    fromInt(e) {
      return (function (e) {
        const t = jr(Nr(e)),
          ...
          d = Gr(r / Br[0]),
          h = Gr(l);
        return [116 * h - 16, 500 * (d - h), 200 * (h - Gr(c))];
      })(e);
    }
    toInt(e) {
  ...
  class ms {
    static quantize(e, t, i) {
      ...
      for (let e = 0; e < c; e++) {
        m.push(new Array());
        for (let t = 0; t < c; t++) m[e].push(new fs());
      }
      const f = new Array();
  ...
  class Cs {
    ...
    constructHistogram(e) {
      (this.weights = Array.from({ length: bs }).fill(0)),
        (this.momentsR = Array.from({ length: bs }).fill(0)),
        (this.momentsG = Array.from({ length: bs }).fill(0)),
        (this.momentsB = Array.from({ length: bs }).fill(0)),
        (this.moments = Array.from({ length: bs }).fill(0));
      const t = vs.quantize(e);
    ...
    computeMoments() {
      for (let e = 1; e < gs; e++) {
        const t = Array.from({ length: gs }).fill(0),
          i = Array.from({ length: gs }).fill(0),
          o = Array.from({ length: gs }).fill(0),
          n = Array.from({ length: gs }).fill(0),
          r = Array.from({ length: gs }).fill(0);
        for (let s = 1; s < gs; s++) {
          let a = 0,
            l = 0,
            c = 0,
    ...
    cut(e, t) {
      const i = this.volume(e, this.momentsR),
        ...
        s = this.maximize(e, ys, e.r0 + 1, e.r1, i, o, n, r),
        a = this.maximize(e, ws, e.g0 + 1, e.g1, i, o, n, r),
        l = this.maximize(e, ks, e.b0 + 1, e.b1, i, o, n, r);
      let c;
      const d = s.maximum,
        h = a.maximum,
        u = l.maximum;
  ...
  class Is {
    static quantize(e, t) {
      const i = new Cs().quantize(e, t);
      return ms.quantize(e, i, t);
    }
  }
  class Ss {
    get primary() {
    ...
    static light(e) {
      return Ss.lightFromCorePalette(us.of(e));
    }
    static dark(e) {
      return Ss.darkFromCorePalette(us.of(e));
    }
    static lightContent(e) {
      return Ss.lightFromCorePalette(us.contentOf(e));
    }
    static darkContent(e) {
      return Ss.darkFromCorePalette(us.contentOf(e));
    }
  ...
  const Es = { desired: 4, fallbackColorARGB: 4282549748, filter: !0 };
  function Ts(e, t) {
  ...
  class Ds {
    constructor() {}
    static score(e, t) {
      const { desired: i, fallbackColorARGB: o, filter: n } = { ...Es, ...t },
        r = [],
        s = new Array(360).fill(0);
      let a = 0;
      for (const [t, i] of e.entries()) {
        const e = Qr.fromInt(t);
        r.push(e);
      ...
      const c = new Array();
      for (const e of r) {
        const t = l[Dr(Math.round(e.hue))];
        if (
          n &&
          (e.chroma < Ds.CUTOFF_CHROMA || t <= Ds.CUTOFF_EXCITED_PROPORTION)
        )
          continue;
        const i = 100 * t * Ds.WEIGHT_PROPORTION,
          o =
            e.chroma < Ds.TARGET_CHROMA
              ? Ds.WEIGHT_CHROMA_BELOW
              : Ds.WEIGHT_CHROMA_ABOVE,
          r = i + (e.chroma - Ds.TARGET_CHROMA) * o;
      ...
      for (let e = 90; e >= 15; e--) {
        ...
        for (const { hct: t } of c) {
          if ((d.find((i) => Mr(t.hue, i.hue) < e) || d.push(t), d.length >= i))
            break;
        }
        if (d.length >= i) break;
      }
  ...
  function As(e) {
    ...
    return (
      t
        ? ((n = Ms(e.slice(0, 1).repeat(2))),
          (r = Ms(e.slice(1, 2).repeat(2))),
          (s = Ms(e.slice(2, 3).repeat(2))))
        : i
        ? ((n = Ms(e.slice(0, 2))),
          (r = Ms(e.slice(2, 4))),
          (s = Ms(e.slice(4, 6))))
  ...
  (Ds.TARGET_CHROMA = 48),
    (Ds.WEIGHT_PROPORTION = 0.7),
    (Ds.WEIGHT_CHROMA_ABOVE = 0.3),
    (Ds.WEIGHT_CHROMA_BELOW = 0.1),
    (Ds.CUTOFF_CHROMA = 5),
    (Ds.CUTOFF_EXCITED_PROPORTION = 0.01);
  const Ps = () => _o("OK", { id: "functions.prompt.confirmText" }),
    Ls = () => _o("Cancel", { id: "functions.prompt.cancelText" }),
    _s = ["light", "dark"],
    Bs = "mdui-custom-color-scheme-";
  let Os = 0;
  const zs = (e) => {
      const t = M(e);
      let i = t
        ...
        .flat();
      (i = L(i).filter((e) => e.startsWith(Bs))), t.removeClass(i.join(" "));
    ...
    Ns = (e, t) => {
      const i = n(),
        ...
        r = { light: Ss.light(e).toJSON(), dark: Ss.dark(e).toJSON() },
        s = us.of(e);
      Object.assign(r.light, {
        ...
        (t?.customColors || []).map((t) => {
          const i = k(t.name),
            ...
            })(e, { name: i, value: As(t.value), blend: !0 });
          _s.forEach((e) => {
            (r[e][i] = o[e].color),
      ...
      zs(o), M(i.head).append(`<style id="${l}">${c}</style>`), o.addClass(l);
    },
    Fs = "mdui.functions.snackbar.";
  let Vs;
  (e.$ = M),
    (e.alert = (e) => {
      const t = Object.assign({}, { confirmText: $r(), onConfirm: x }, e),
        i = [
          "headline",
          "description",
          "icon",
      ...
      return new Promise((o, n) => {
        ...
        e.confirmText ||
          hn(s, () => {
            M(s).find('[slot="action"]').text($r());
          }),
          M(s).on("close", (e) => {
            e.target === s && (r ? o() : n(), un(s));
          });
      });
    }),
    (e.breakpoint = Nn),
    (e.confirm = (e) => {
      const t = Object.assign(
          {},
          { confirmText: Rr(), cancelText: Ir(), onConfirm: x, onCancel: x },
          e
        ),
        i = [
          "headline",
      ...
      return new Promise((o, n) => {
        ...
        e.confirmText ||
          hn(s, () => {
            M(s).find('[slot="action"]').last().text(Rr());
          }),
          e.cancelText ||
            hn(s, () => {
              M(s).find('[slot="action"]').first().text(Ir());
            }),
          M(s).on("close", (e) => {
            e.target === s && (r ? o() : n(), un(s));
          });
    ...
    (e.loadLocale = (e) => {
      ((e) => {
        const t = s(),
          i = tn({ sourceLocale: "en-us", targetLocales: rn, loadLocale: e });
        (an = i.getLocale),
          (ln = i.setLocale),
          t.addEventListener(Mo, (e) => {
            t.dispatchEvent(
              new CustomEvent("mdui-localize-status", { detail: e.detail })
            );
          });
      })(e);
    }),
    ...
    (e.prompt = (t) => {
      ...
      return (
        ...
        new Promise((e, r) => {
          ...
          t.confirmText ||
            hn(a, () => {
              M(a).find('[slot="action"]').last().text(Ps());
            }),
            t.cancelText ||
              hn(a, () => {
                M(a).find('[slot="action"]').first().text(Ls());
              }),
            M(a).on("close", (t) => {
              t.target === a && (s ? e(n.value) : r(), un(a));
            });
        })
      );
    }),
    ...
    (e.snackbar = (t) => {
      ...
      return (
        ...
        o.appendTo("body").on("closed", (e) => {
          e.target === i &&
            (o.remove(), t.queue && ((Vs = void 0), yr(Fs + t.queue)));
        }),
        t.queue
          ? Vs
            ? br(Fs + t.queue, () => {
