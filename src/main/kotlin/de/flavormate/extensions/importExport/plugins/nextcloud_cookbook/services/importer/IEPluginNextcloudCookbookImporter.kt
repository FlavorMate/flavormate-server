...
class IEPluginNextcloudCookbookImporter(
   ...
   * [de.flavormate.extensions.importExport.plugins.ld_json.services.importer.IEPluginLDJsonImporter.import],
   * but with a different mapping for instructions, as the Nextcloud Cookbook plugin only supports
   * [de.flavormate.extensions.importExport.plugins.ld_json.models.types.step.LDJsonHowToStep]
   * (Plain instructions, no grouping or nesting) Also only one file is supported per recipe.
   */
