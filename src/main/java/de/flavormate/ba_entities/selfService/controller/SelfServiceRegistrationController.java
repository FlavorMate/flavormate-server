...
/**
 * SelfServiceRegistrationController handles the self-service registration process. This controller
 * is activated based on the property "flavormate.features.registration.enabled" and allows
 * anonymous users to create accounts through a REST API endpoint.
 */
