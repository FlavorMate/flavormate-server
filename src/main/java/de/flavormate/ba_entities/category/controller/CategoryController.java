...
public class CategoryController
    implements IExtractRecipesController,
        IPageableL10nController<Category>,
        ISearchL10nController<Category> {

  private final CategoryService categoryService;

  @Override
  public Page<Recipe> findRecipesFromParent(
      Long id, int page, int size, String sortBy, String sortDirection) throws CustomException {
  ...
  public Page<Category> findByPage(
      String language, int page, int size, String sortBy, String sortDirection)
  ...
  @Override
  public Page<Category> findBySearch(
      String language, String searchTerm, int page, int size, String sortBy, String sortDirection) {
    var pageable = RequestUtils.convertPageable(page, size, sortBy, sortDirection);
    return categoryService.findBySearch(language, searchTerm, pageable);
  }

  @GetMapping("/notEmpty")
  public Page<Category> findByNotEmpty(
