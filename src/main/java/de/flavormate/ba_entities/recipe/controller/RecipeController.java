...
public class RecipeController
    implements ICRUDController<Recipe, RecipeDraft>,
        ISearchDietController<Recipe>,
        IPageableDietController<Recipe> {
  ...
  public List<Recipe> getRandom(
      @PathVariable RecipeDiet diet,
      @RequestParam(name = "course", defaultValue = "%") String courseStr,
  ...
  @GetMapping("/{id}/l10n")
  public Recipe findByIdL10n(@PathVariable Long id, @RequestParam String language)
      throws CustomException {
  ...
  @Override
  public Page<Recipe> findByPage(
      RecipeDiet diet, int page, int size, String sortBy, String sortDirection)
      throws CustomException {
  ...
  @Override
  public Page<Recipe> findBySearch(
      String searchTerm, RecipeDiet diet, int page, int size, String sortBy, String sortDirection) {
    var pageable = RequestUtils.convertPageable(page, size, sortBy, sortDirection);
