...
public interface BookRepository extends JpaRepository<Book, Long> {
  ...
  @Query(
      "select b from Book b where b.id = :id and (b.visible or b.owner.account.username ="
          + " :username)")
  ...
  @Query(
      "select b from Book b where lower(b.label) like lower(concat('%', :searchTerm, '%')) and"
          + " (b.visible or b.owner.account.username = :username)")
  Page<Book> findBySearch(
