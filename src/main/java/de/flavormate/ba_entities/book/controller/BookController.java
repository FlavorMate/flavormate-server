...
public class BookController
    implements ICRUDController<Book, BookDraft>,
        IExtractRecipesController,
        IPageableController<Book>,
        ISearchController<Book> {
  ...
  @Override
  public Page<Book> findByPage(int page, int size, String sortBy, String sortDirection)
  ...
  public Book toggleRecipeInBook(@PathVariable Long bookId, @PathVariable Long recipeId)
      throws CustomException {
