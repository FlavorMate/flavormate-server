...
public class JSONUtils {
	...
	public static <T> T extractField(JsonNode body, String fieldName, Class<T> clazz) {
		return Optional.ofNullable(body.get(fieldName))
				.map(jsonNode -> JSONUtils.mapper.convertValue(jsonNode, clazz)).orElse(null);
	}
	 ...
	 * @return A List of objects with elements converted to the specified data type, or an empty
